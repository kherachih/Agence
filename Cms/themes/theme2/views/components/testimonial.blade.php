...
<div class="tg-testimonial-area tg-grey-bg pt-130 pb-110 p-relative z-index-1">
    <img class="tg-testimonial-2-shape p-absolute" src="{{ asset('frontend/assets/img/shape/tower.png') }}" alt="">
            ...
            <div class="col-lg-12">
                <div class="tg-location-section-title text-center mb-30">
                    ...
                    <p class="text-capitalize wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".9s">
                        {!! strip_tags(clean(getTranslatedValue($home2_testimonial, 'description')), '<br>') !!}
                    </p>
                </div>
            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="tg-testimonial-item mb-30">
                                    ...
                                    <p class="tg-testimonial-avatar-para mb-10">“
                                        {{ $testimonial?->translate?->comment }} ”</p>
