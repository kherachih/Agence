...
@if ($theme6_why_choose)
    <!-- tg-chose-us-area-start -->
    <div class="tg-chose-area p-relative z-index-1  tg-grey-bg pt-140 pb-100">
        <img class="tg-chose-4-shape p-absolute" src="{{ asset('frontend/assets/img/shape/map-shape-5.png') }}"
            alt="shape">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="tg-chose-content mb-35">
                        ...
                        <div class="tg-chose-list-wrap">
                            ...
                            <div class="tg-chose-btn wow fadeInUp" data-wow-delay=".8s" data-wow-duration=".9s">
                                <a href="{{ getTranslatedValue($theme6_why_choose, 'button_url') }}"
                                    class="tg-btn tg-btn-switch-animation">
                                    <span class="d-flex align-items-center justify-content-center">
                                        <span
                                            class="btn-text">{{ getTranslatedValue($theme6_why_choose, 'button_text') }}</span>
                                ...
                                <div class="tg-chose-3-thumb">
                                    <div class="tg-chose-3-rounded p-relative mb-20">
                                        <img class="rotate-infinite-2"
                                            src="{{ asset('frontend/assets/img/shape/circle-text.png') }}"
                                            alt="">
                                        <img class="tg-chose-3-star"
                                            src="{{ asset('frontend/assets/img/shape/star.png') }}" alt="">
                                    </div>
                                    <img class="main-thumb"
                                        src="{{ asset(getSingleImage($theme6_why_choose, 'small_image')) }}"
                                        alt="thumb">
                                </div>
                            </div>
                                ...
                                <div class="tg-chose-3-thumb-inner p-relative">
                                    <div class="tg-chose-3-thumb-2">
                                        <img class="w-100 tg-round-15"
                                            src="{{ asset(getSingleImage($theme6_why_choose, 'big_image')) }}"
                                            alt="chose">
                                    </div>
                                </div>
                            </div>
