...
<div class="tg-blog-area tg-blog-space tg-grey-bg pt-135 p-relative z-index-1">
    <img class="tg-blog-shape" src="{{ asset('frontend/assets/img/shape/map-shape-10.png') }}" alt="shape">
    <img class="tg-blog-shape-2" src="{{ asset('frontend/assets/img/shape/map-shape-11.png') }}" alt="shape">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="tg-location-section-title text-center mb-30">
                    <h5 class="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".9s">
                        {{ getTranslatedValue($theme7_blog, 'sub_title') }}
                    </h5>
                    <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                        {!! strip_tags(clean(getTranslatedValue($theme7_blog, 'title')), '<br>') !!}
                    </h2>
                    <p class="text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">
                        {!! strip_tags(clean(getTranslatedValue($theme7_blog, 'description')), '<br>') !!}
                    </p>
                </div>
            </div>
            @if ($blogs->count() > 0)
                        ...
                        <div class="tg-blog-content  p-relative">
                            ...
                            <div class="tg-blog-date">
                                <span class="mr-20">
                                    ...
                                    {{ $firstBlog->created_at->format('jS M, Y') }}
                                </span>
