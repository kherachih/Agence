            ...
            <div class="col-6">
                <div class="tg-mobile-logo">
                    <a href="{{ route('home') }}">
                        ...
                        @else
                            <img src="{{ asset('frontend/assets/img/logo/logo.png') }}" alt="Logo" class="logo-img">
                        @endif
                    </a>
                </div>
            </div>
                ...
                <div class="tg-mobile-search-box">
                    ...
                    <div class="tg-mobile-search-item">
                        <div class="tg-mobile-search-dropdown" @click="toggleDropdown('location')">
                            ...
                            <div class="tg-mobile-search-content">
                                <span class="tg-mobile-search-label">{{ __('translate.Location') }}</span>
                                <span class="tg-mobile-search-value" x-text="destination || '{{ __('translate.Where to ?') }}'"></span>
                            </div>
                    ...
                    <div class="tg-mobile-search-item">
                        <div class="tg-mobile-search-dropdown" @click="toggleDropdown('month')">
                            ...
                            <div class="tg-mobile-search-content">
                                <span class="tg-mobile-search-label">{{ __('translate.Month') }}</span>
                                <span class="tg-mobile-search-value" x-text="selected_month || '{{ __('translate.Select Month') }}'"></span>
                            </div>
                            <div class="tg-mobile-search-arrow">
                                <svg width="14" height="8" viewBox="0 0 14 8" fill="none">
                                    <path d="M1.6665 1L6.99984 6.33333L12.3332 1" stroke="#353844" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="tg-mobile-search-item">
                        <div class="tg-mobile-search-dropdown" @click="toggleDropdown('guests')">
                            ...
                            <div class="tg-mobile-search-content">
                                ...
                                <span class="tg-mobile-search-value" x-text="guestText || '{{ __('translate.+ Add Guests') }}'"></span>
                            </div>
                            <div class="tg-mobile-search-arrow">
                                <svg width="14" height="8" viewBox="0 0 14 8" fill="none">
                                    <path d="M1.6665 1L6.99984 6.33333L12.3332 1" stroke="#353844" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
