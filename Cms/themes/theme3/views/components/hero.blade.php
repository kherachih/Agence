                                ...
                                <div class="tg-booking-form-input-group d-flex align-items-end justify-content-between">
                                    ...
                                    <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-10">
                                        ...
                                        <div class="tg-booking-form-location-list tg-quantity tg-booking-quantity-active month-dropdown">
                                            <ul class="month-list">
                                                <li @click="selectMonth('{{ __('translate.January') }}', '01', $event)">
                                                    <i class="fas fa-calendar-alt"></i>
                                                    <span>{{ __('translate.January') }}</span>
                                                </li>
                                                <li @click="selectMonth('{{ __('translate.February') }}', '02', $event)">
                                                    <i class="fas fa-calendar-alt"></i>
                                                    <span>{{ __('translate.February') }}</span>
                                                </li>
                                                <li @click="selectMonth('{{ __('translate.March') }}', '03', $event)">
                                                    <i class="fas fa-calendar-alt"></i>
                                                    <span>{{ __('translate.March') }}</span>
                                                </li>
                                                <li @click="selectMonth('{{ __('translate.April') }}', '04', $event)">
                                                    <i class="fas fa-calendar-alt"></i>
                                                    <span>{{ __('translate.April') }}</span>
                                                </li>
                                                <li @click="selectMonth('{{ __('translate.May') }}', '05', $event)">
                                                    <i class="fas fa-calendar-alt"></i>
                                                    <span>{{ __('translate.May') }}</span>
                                                </li>
                                                <li @click="selectMonth('{{ __('translate.June') }}', '06', $event)">
                                                    <i class="fas fa-calendar-alt"></i>
                                                    <span>{{ __('translate.June') }}</span>
                                                </li>
                                                <li @click="selectMonth('{{ __('translate.July') }}', '07', $event)">
                                                    <i class="fas fa-calendar-alt"></i>
                                                    <span>{{ __('translate.July') }}</span>
                                                </li>
                                                <li @click="selectMonth('{{ __('translate.August') }}', '08', $event)">
                                                    <i class="fas fa-calendar-alt"></i>
                                                    <span>{{ __('translate.August') }}</span>
                                                </li>
                                                <li @click="selectMonth('{{ __('translate.September') }}', '09', $event)">
                                                    <i class="fas fa-calendar-alt"></i>
                                                    <span>{{ __('translate.September') }}</span>
                                                </li>
                                                <li @click="selectMonth('{{ __('translate.October') }}', '10', $event)">
                                                    <i class="fas fa-calendar-alt"></i>
                                                    <span>{{ __('translate.October') }}</span>
                                                </li>
                                                <li @click="selectMonth('{{ __('translate.November') }}', '11', $event)">
                                                    <i class="fas fa-calendar-alt"></i>
                                                    <span>{{ __('translate.November') }}</span>
                                                </li>
                                                <li @click="selectMonth('{{ __('translate.December') }}', '12', $event)">
                                                    <i class="fas fa-calendar-alt"></i>
                                                    <span>{{ __('translate.December') }}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-10">
                                        <span class="tg-booking-form-title">{{ __('translate.Who is travelling?') }}</span>
                                        <div class="tg-booking-add-input-field tg-booking-quantity-toggle">
                                            <span class="location">
                                            ...
                                            <div>
                                                ...
                                                <span x-show="adults || children"
                                                    ...
                                                    <template x-if="adults">
                                                        <span class="tg-booking-title-value m-0" x-text="', ' + adults + ' ' + '{{ __('translate.Adult') }}'"></span>
                                                    </template>
                                                    <template x-if="children">
                                                        <span class="tg-booking-title-value m-0" x-text="', ' + children + ' ' + '{{ __('translate.Child') }}'"></span>
                                                    </template>
                                                </span>
                                            </div>
