...
Route::group(['as' => 'admin.tourbooking.', 'prefix' => 'admin/tourbooking', 'middleware' => ['auth:admin']], function () {
    ...
    Route::post('services/{service}/availability/periods', [ServiceController::class, 'storeAvailabilityPeriods'])->name('services.availability.periods.store');
    Route::delete('services/availability/periods/{period}', [ServiceController::class, 'deleteAvailabilityPeriod'])->name('services.periods.destroy');
...
Route::group(['as' => 'agency.tourbooking.', 'prefix' => 'agency/tourbooking', 'middleware' => ['auth', 'CheckAgency']], function () {
    ...
    Route::post('services/{service}/availability/periods', [AgencyServiceController::class, 'storeAvailabilityPeriods'])->name('services.availability.periods.store');
    Route::delete('services/availability/periods/{period}', [AgencyServiceController::class, 'deleteAvailabilityPeriod'])->name('services.periods.destroy');
...
Route::group(['as' => 'front.tourbooking.', 'prefix' => 'tour-booking', 'middleware' => ['web']], function () {
    ...
    Route::get('/service/{slug}/download-tour-plan', [FrontServiceController::class, 'downloadTourPlanPdf'])->name('services.download-tour-plan');
