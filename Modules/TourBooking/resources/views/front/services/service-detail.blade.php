                        ...
                        <div class="col-xl-9 col-lg-8 order-2 order-lg-1">
                            ...
                            @if ($service->availability_periods && $service->availability_periods->count() > 0)
                                <div class="tg-tour-availability-section" id="availability-section" style="display: none;">
                                    <div class="tg-tour-about-border mb-40"></div>
                                    <h4 class="tg-tour-about-title mb-20">{{ __('translate.Availability & Booking') }}</h4>
                                    ...
                                    <ul class="am-tour-availability__list">
                                        @foreach($service->availability_periods as $period)
                                            ...
                                            @endphp
                                            <li class="am-tour-availability__variant js-am-tour-availability__variant" data-cy="tdp-availability--card" data-year="{{ $startDate->year }}" data-month="{{ $startDate->month }}" style="display: none;">
                                                <div class="am-tour-availability__variant-discount-container">
                                                    <div class="am-tour-availability__variant-instant-label">
                                                        {{ __('translate.Instant Confirmation') }}
                                                    </div>
                                                    @if($hasDiscount)
                                                        <div class="am-tour-availability__variant-discount-tag">-{{ $discountPercentage }}%</div>
                                                    @endif
                                                </div>
                                                        ...
                                                        <div class="am-tour-availability__variant-date-wrapper">
                                                            <div class="am-tour-availability__variant-date-start">
                                                                <div class="am-tour-availability__variant-date-item am-tour-availability__variant-date-item-week">
                                                                    {{ __('translate.From') }} {{ $startDate->translatedFormat('l') }}
                                                                </div>
                                                            ...
                                                            <div class="am-tour-availability__variant-date-finish">
                                                                <div class="am-tour-availability__variant-date-item am-tour-availability__variant-date-item-week">
                                                                    {{ __('translate.To') }} {{ $endDate->translatedFormat('l') }}
                                                                </div>
                                                    ...
                                                    <div class="am-tour-availability__variant-wrapper-item">
                                                        <div class="am-tour-availability__variant-price-container">
                                                            ...
                                                            <div class="am-tour-availability__variant-price-values">
                                                                ...
                                                                <div class="am-tour-availability__variant-price--current" data-cy="tdp-availability--price">
                                                                    {{ currency($finalPrice) }}
                                                                    <span class="am-tour-availability__variant-price--current-per-person"> {{ __('translate.per person') }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="am-tour-availability__variant-list-item am-tour-availability__variant-list-item--room">
                                                            {{ __('translate.Price based on shared room') }}
                                                        </div>
                                                        <div class="am-tour-availability__variant-cta-wrapper">
                                                            <form action="{{ route('front.tourbooking.book.checkout.view') }}" method="GET">
                                                                ...
                                                                <input type="hidden" name="availability_period_id" value="{{ $period->id }}">
                                                                <input type="hidden" name="check_in_date" value="{{ $period->start_date }}">
                                ...
                                @if($showQuoteForm)
                                    <form action="{{ route('quote-request.store') }}" method="POST">
                                        ...
                                        <div class="tg-booking-form-parent-inner mb-10">
                                            ...
                                            <div class="mb-3">
                                                 <label class="form-label">{{ __('translate.Date Depart') }}</label>
                                                <input required class="form-control flatpickr" name="date_depart" type="text" placeholder="{{ __('translate.Select Date') }}" value="{{ now()->format('Y-m-d') }}">
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">{{ __('translate.Date Retour') }}</label>
                                                <input required class="form-control flatpickr" name="date_retour" type="text" placeholder="{{ __('translate.Select Date') }}" value="{{ now()->addDays(7)->format('Y-m-d') }}">
                                            </div>
                                            ...
                                            <div class="tg-tour-about-time mb-10">
                                                ...
                                                <div class="month-selector-v2">
                                                    ...
                                                    <div class="year-tabs-wrapper mb-25">
                                                        <span class="year-selector-label d-block mb-10">{{ __('translate.Select Year') }}</span>
                                                        <div class="year-tabs-list">
                                                            @foreach($years as $year)
                                                                <div class="year-tab {{ $loop->first ? 'active' : '' }}" data-year="{{ $year }}">
                                                                    ...
                                                                    {{-- <span class="year-count">({{ $availableMonthsCount }})</span> --}}
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        function bookingForm() {
            return {
                ...
                basePricePerAdult: {{ $service->discount_adult_price ?? $service->adult_price ?? 0 }},
                basePricePerChild: {{ $service->discount_child_price ?? $service->child_price ?? 0 }},
