                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="card mt-4">
                                                    ...
                                                    <div class="list-group list-group-flush">
                                                        <a href="{{ route('admin.tourbooking.services.itineraries', $service->id) }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                                            {{ __('translate.Itineraries') }}
                                                            <span class="badge bg-primary rounded-pill">{{ $service->itineraries->count() }}</span>
                                                        </a>
                                                        <a href="{{ route('admin.tourbooking.services.extra-charges', $service->id) }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                                            {{ __('translate.Extra Charges') }}
                                                            <span class="badge bg-primary rounded-pill">{{ $service->extraCharges->count() }}</span>
                                                        </a>
                                                        <a href="{{ route('admin.tourbooking.services.availability', $service->id) }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                                            {{ __('translate.Availability') }}
                                                        </a>
                                                        <a href="{{ route('admin.tourbooking.services.media', $service->id) }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
