...
<li
    class="{{ Route::is('admin.tourbooking.continents.index') || Route::is('admin.tourbooking.continents.create') || Route::is('admin.tourbooking.destinations.index') || Route::is('admin.tourbooking.destinations.create') ? 'active' : '' }}">
    <a href="#!" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item__destination_list"><span
            ...
            class="crancy__toggle"></span></a></span>
    <!-- Dropdown Menu -->
    <div class="collapse crancy__dropdown {{ Route::is('admin.tourbooking.continents.index') || Route::is('admin.tourbooking.continents.create') || Route::is('admin.tourbooking.destinations.index') || Route::is('admin.tourbooking.destinations.create') ? 'show' : '' }}"
        id="menu-item__destination_list" data-bs-parent="#CrancyMenu">
        <ul class="menu-bar__one-dropdown">

            <li><a href="{{ route('admin.tourbooking.continents.index') }}"><span class="menu-bar__text"><span
                            class="menu-bar__name">{{ __('translate.Continents') }}</span></span></a></li>

            <li><a href="{{ route('admin.tourbooking.destinations.index') }}"><span class="menu-bar__text"><span
                            class="menu-bar__name">{{ __('translate.Destinations') }}</span></span></a></li>

            <li><a href="{{ route('admin.tourbooking.destinations.create') }}"><span class="menu-bar__text"><span
...
<li class="{{ Route::is('admin.tourbooking.bookings.index') ? 'active' : '' }}">
    <a class="collapsed" href="{{ route('admin.tourbooking.bookings.index') }}">
...
<li class="{{ Route::is('admin.tourbooking.reviews.index') || Route::is('admin.tourbooking.reviews.detail') ? 'active' : '' }}">
    <a class="collapsed" href="{{ route('admin.tourbooking.reviews.index') }}">
        <span class="menu-bar__text">
            <span class="crancy-menu-icon crancy-svg-icon__v1">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
