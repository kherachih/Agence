...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Dashboard') }} >> {{ __('translate.Bookings') }} >>
        {{ __('translate.Add Passenger Information') }}</p>
@endsection
                        ...
                        <div class="crancy-dsinner">
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong>{{ __('translate.Booking Code') }}:</strong>
                                        ...
                                        <div class="card mb-3 passenger-card" data-index="{{ $i }}">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <label
                                                            class="form-label">{{ __('translate.Passport Expiry Date') }}</label>
                                                        <input type="date"
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        <label class="form-label">
                                                            {{ __('translate.Travel Documents') }} <span
                                                        ...
                                                        <small class="text-muted d-block mt-1">
                                                            ...
                                                            <br>
                                                            2. {{ __('translate.Flight Ticket') }}
                                                            ({{ __('translate.Optional') }})
                                                            <br>
                                                            3. {{ __('translate.Travel Insurance') }}
                                                            ({{ __('translate.Optional') }})
                                                            <br>
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        <label
                                                            class="form-label">{{ __('translate.Special Requirements') }}</label>
                                                        <textarea
