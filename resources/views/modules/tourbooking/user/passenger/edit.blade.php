...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Edit Passenger Information') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Dashboard') }} >> {{ __('translate.Bookings') }} >> {{ __('translate.Edit Passenger Information') }}</p>
@endsection
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        <div class="crancy-dsinner">
                            ...
                            <!-- Passenger Form -->
                            <form action="{{ route('user.passengers.update', $booking) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                <div id="passenger-forms-container">
                                    @foreach($passengers as $index => $passenger)
                                        <div class="card mb-3 passenger-card" data-index="{{ $index }}">
                                            <div class="card-header">
                                                <h5 class="mb-0">
                                                    {{ __('translate.Passenger') }} {{ $index + 1 }}
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="date" 
                                                               class="form-control @error('passengers.'.$index.'.date_of_birth') is-invalid @enderror" 
                                                               name="passengers[{{ $index }}][date_of_birth]" 
                                                               value="{{ $passenger->date_of_birth ? $passenger->date_of_birth->format('Y-m-d') : '' }}">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <select class="form-select @error('passengers.'.$index.'.gender') is-invalid @enderror" 
                                                            ...
                                                            <option value="other" {{ $passenger->gender == 'other' ? 'selected' : '' }}>
                                                                {{ __('translate.Other') }}
                                                            </option>
                                                        </select>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="text" 
                                                               class="form-control @error('passengers.'.$index.'.nationality') is-invalid @enderror" 
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" 
                                                               class="form-control @error('passengers.'.$index.'.passport_number') is-invalid @enderror" 
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="date" 
                                                               class="form-control @error('passengers.'.$index.'.passport_expiry_date') is-invalid @enderror" 
                                                               name="passengers[{{ $index }}][passport_expiry_date]" 
                                                               value="{{ $passenger->passport_expiry_date ? $passenger->passport_expiry_date->format('Y-m-d') : '' }}">
                                                        @error('passengers.'.$index.'.passport_expiry_date')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label">
                                                            {{ __('translate.Passport Copy') }}
                                                        </label>
                                                        <input type="file" 
                                                               class="form-control @error('passengers.'.$index.'.passport_file') is-invalid @enderror" 
                                                               name="passengers[{{ $index }}][passport_file]" 
                                                               accept=".pdf,.jpg,.jpeg,.png">
                                                        <small class="text-muted">{{ __('translate.Accepted formats: PDF, JPG, PNG (Max 5MB)') }}</small>
                                                        @if($passenger->passport_file)
                                                            <div class="mt-2">
                                                                <a href="{{ $passenger->passport_file_url }}" target="_blank" class="btn btn-xs btn-outline-primary">
                                                                    <i class="fas fa-file-pdf"></i> {{ __('translate.View Current') }}
                                                                </a>
                                                            </div>
                                                        @endif
                                                        @error('passengers.'.$index.'.passport_file')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="file" 
                                                               class="form-control @error('passengers.'.$index.'.insurance_file') is-invalid @enderror" 
                                                               name="passengers[{{ $index }}][insurance_file]" 
                                                               accept=".pdf,.jpg,.jpeg,.png">
                                                        <small class="text-muted">{{ __('translate.Accepted formats: PDF, JPG, PNG (Max 5MB)') }}</small>
                                                        @if($passenger->insurance_file)
                                                            <div class="mt-2">
                                                                <a href="{{ $passenger->insurance_file_url }}" target="_blank" class="btn btn-xs btn-outline-success">
                                                                    <i class="fas fa-shield-alt"></i> {{ __('translate.View Current') }}
                                                                </a>
                                                            </div>
                                                        @endif
                                                        @error('passengers.'.$index.'.insurance_file')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" 
                                                               class="form-control @error('passengers.'.$index.'.phone') is-invalid @enderror" 
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="email" 
                                                               class="form-control @error('passengers.'.$index.'.email') is-invalid @enderror" 
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        ...
                                                        <textarea class="form-control @error('passengers.'.$index.'.special_requirements') is-invalid @enderror" 
                                                                  name="passengers[{{ $index }}][special_requirements]" 
                                                                  rows="3"
                                                                  placeholder="{{ __('translate.Any special requirements or dietary restrictions...') }}">{{ $passenger->special_requirements }}</textarea>
                                                        @error('passengers.'.$index.'.special_requirements')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        {{ __('translate.Update Passenger Information') }}
                                    </button>
                                </div>
                            </form>
                        </div>
