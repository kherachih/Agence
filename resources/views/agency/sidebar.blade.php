...
<div class="admin-menu__one crancy-sidebar-padding mg-top-20">
    ...
    <div class="menu-bar">
        <ul id="CrancyMenu" class="menu-bar__one crancy-dashboard-menu">
            ...
            <li class="{{ Route::is('agency.dashboard') ? 'active' : '' }}"><a class="collapsed"
                    href="{{ route('agency.dashboard') }}"><span class="menu-bar__text">
            ...
            <li class="{{ Route::is('agency.edit-profile') ? 'active' : '' }}"><a class="collapsed"
                    href="{{ route('agency.edit-profile') }}">
            ...
            <li class="{{ Route::is('agency.agency-profile') ? 'active' : '' }}"><a class="collapsed"
                    href="{{ route('agency.agency-profile') }}">
                    <span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
            ...
            <li class="{{ Route::is('agency.change-password') ? 'active' : '' }}"><a class="collapsed"
                    href="{{ route('agency.change-password') }}">
                    <span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <li
                class="{{ Route::is('agency.agency-supports') || Route::is('agency.agency-support') ? 'active' : '' }}">
                <a class="collapsed" href="{{ route('agency.agency-supports') }}">
                    <span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="{{ Route::is('agency.support-ticket.*') ? 'active' : '' }}"><a class="collapsed"
                    href="{{ route('agency.support-ticket.index') }}">
                    <span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="{{ Route::is('agency.account-delete') ? 'active' : '' }}"><a class="collapsed"
                    href="{{ route('agency.account-delete') }}">
                    <span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
