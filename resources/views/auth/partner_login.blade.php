...
@section('title')
    <title>{{ __('translate.Partner Login') }}</title>
@endsection
                ...
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="tg-login-wrapper">
                        <div class="tg-login-top text-center mb-30">
                            <h2>{{ __('translate.Partner Login') }}</h2>
                            <p>{{ __('translate.Enter your credentials to access your partner account') }}.</p>
                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="tg-login-navigate mb-25">
                                                    <a
                                                        href="{{ route('agency.registration') }}">{{ __('translate.Register Now') }}</a>
                                                </div>
                                            </div>
