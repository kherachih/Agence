...
@section('title')
<title>{{ __('translate.Edit Promotion') }}</title>
@endsection
@section('body-header')
<h3 class="crancy-header__title m-0">{{ __('translate.Edit Promotion') }}</h3>
<p class="crancy-header__text">{{ __('translate.Manage Content') }} >> {{ __('translate.Promotions') }} >> {{ __('translate.Edit') }}</p>
@endsection
                                        ...
                                        <div class="crancy-table__inner">
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <input type="text" name="title" class="crancy-form__control" value="{{ old('title', $promotion->title) }}" placeholder="{{ __('translate.e.g. Summer Sale') }}" required>
                                                </div>
                                                @error('title')
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <textarea name="message" class="crancy-form__control" rows="3" placeholder="{{ __('translate.Enter the promotional message that will scroll across the bar') }}" required>{{ old('message', $promotion->message) }}</textarea>
                                                </div>
                                                @error('message')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <input type="url" name="link_url" class="crancy-form__control" value="{{ old('link_url', $promotion->link_url) }}" placeholder="{{ __('translate.e.g. https://example.com/promotion') }}">
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <input type="text" name="link_text" class="crancy-form__control" value="{{ old('link_text', $promotion->link_text) }}" placeholder="{{ __('translate.e.g. Shop Now') }}">
                                        ...
                                        <div class="crancy-table__inner">
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input d-flex align-items-center gap-2">
                                                    <input type="color" name="background_color" class="form-control form-control-color" value="{{ old('background_color', $promotion->background_color) }}" style="width: 50px; height: 40px;">
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input d-flex align-items-center gap-2">
                                                    <input type="color" name="text_color" class="form-control form-control-color" value="{{ old('text_color', $promotion->text_color) }}" style="width: 50px; height: 40px;">
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <input type="number" name="sort_order" class="crancy-form__control" value="{{ old('sort_order', $promotion->sort_order) }}" placeholder="0">
                                            ...
                                            <div class="crancy-form__box mt-4">
                                                <button type="submit" class="crancy-btn crancy-btn__success w-100">
                                                    <i class="fas fa-save"></i> {{ __('translate.Update Promotion') }}
                                                </button>
                                            </div>
