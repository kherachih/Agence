                                    ...
                                    <div class="col-lg-4">
                                        <div class="crancy-table__inner">
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <input type="date" name="starts_at" class="crancy-form__control" value="{{ old('starts_at') }}">
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <input type="date" name="ends_at" class="crancy-form__control" value="{{ old('ends_at') }}">
