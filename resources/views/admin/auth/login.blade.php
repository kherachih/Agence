									...
									<div class="crancy-wc__form-middle">
										<div class="crancy-wc__form-top">
											...
											@if ($has_super_admin)
												<div class="crancy-wc__heading pd-btm-20">
													<h3 class="crancy-wc__form-title crancy-wc__form-title__one m-0">
														{{ __('translate.Login Here') }}
													</h3>
													<p>{{ __('translate.Welcome to Tour your World Admin Panel') }}</p>
												</div>
												<!-- Sign in Form -->
												<form class="crancy-wc__form-main" action="{{ route('admin.store-login') }}"
													method="post">
													@csrf
													<div class="row">
														<div class="col-12">
													...
													<div class="form-group mg-top-30">
														<div class="crancy-wc__button">
															<button class="ntfmax-wc__btn"
																type="submit">{{ __('translate.Login Now') }}</button>
														</div>
													</div>
											...
											@else
												<div class="crancy-wc__heading pd-btm-20">
													<h3 class="crancy-wc__form-title crancy-wc__form-title__one m-0">
														{{ __('translate.Create Admin Account') }}
													</h3>
													<p>{{ __('translate.Welcome to Tour your WorldAdmin Panel') }}</p>
												</div>
												<!-- Sign in Form -->
												<form class="crancy-wc__form-main"
													...
													<div class="form-group mg-top-30">
														<div class="crancy-wc__button">
															<button class="ntfmax-wc__btn"
																type="submit">{{ __('translate.Create Now') }}</button>
														</div>
													</div>
