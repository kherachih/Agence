...
<div class="admin-menu__one crancy-sidebar-padding mg-top-20">
    ...
    <div class="menu-bar">
        <ul id="CrancyMenu" class="menu-bar__one crancy-dashboard-menu">
            ...
            @if(\App\Models\MenuVisibilitySetting::isMenuEnabled('manage_withdraw') && auth('admin')->user()->admin_type == 'super_admin')
                <li
            ...
            @if(auth('admin')->user()->admin_type == 'super_admin')
                <li class="{{ Route::is('admin.admin-management.*') ? 'active' : '' }}">
                    <a class="collapsed" href="{{ route('admin.admin-management.index') }}">
                        <span class="menu-bar__text">
                            <span class="crancy-menu-icon crancy-svg-icon__v1">
                            ...
                            <span class="menu-bar__name">{{ __('translate.Manage Admin') }}</span>
                        </span>
                    </a>
                </li>
            @endif
            ...
            @if(\App\Models\MenuVisibilitySetting::isMenuEnabled('manage_content'))
                <li
                    ...
                    <div class="collapse crancy__dropdown {{ Route::is('admin.front-end.frontend-section') || Route::is('admin.front-end.section') || Route::is('admin.testimonial.*') || Route::is('admin.partner.*') || Route::is('admin.footer') ? 'show' : '' }}"
                        ...
                        @if(\App\Models\MenuVisibilitySetting::isMenuEnabled('manage_content'))
                        <li class="{{ Route::is('admin.promotion.*') ? 'active' : '' }}">
                            <a class="collapsed" href="{{ route('admin.promotion.index') }}">
                                <span class="menu-bar__text">
                                    <span class="crancy-menu-icon crancy-svg-icon__v1">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span class="menu-bar__name">{{ __('translate.Promotions') }}</span>
                                </span>
                            </a>
                        </li>
                        @endif
                        ...
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" />
                                <circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.5" />
                                <path d="M12 2V4M12 20V22M22 12H20M4 12H2" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" />
                            </svg>
                        </span>
