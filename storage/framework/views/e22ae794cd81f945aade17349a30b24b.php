<footer>
    <div class="tg-footer-area tg-footer-space include-bg"
        data-background="<?php echo e(asset('frontend/assets/img/shape/home-1-footer-bg.jpeg')); ?>">
        <div class="container">
                        ...
                        <div class="tg-footer-widget mb-40">
                            <div class="tg-footer-logo mb-20">
                                <a href="<?php echo e(route('home')); ?>"><img
                                        src="<?php echo e(asset(!empty($general_setting->logo_white) ? $general_setting->logo_white : $general_setting->footer_logo)); ?>"
                                        alt=""></a>
                            </div>
...
<!-- End Footer Section --><?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme3/views/components/footer.blade.php ENDPATH**/ ?>