                            ...
                            <div class="tg-filter-item">
                                ...
                                <div x-data="{ showPropertyType: false }">
                                    ...
                                    <div class="tg-filter-list">
                                        <ul>
                                            <?php $__currentLoopData = $serviceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $serviceType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li x-show="showPropertyType || <?php echo e($key); ?> < 4" x-transition>
                                                    <div class="checkbox d-flex">
                                                        <input value="<?php echo e($serviceType?->id); ?>"
                                                            x-model="filters.service_type_ids" class="tg-checkbox"
                                                            type="checkbox" id="australia_<?php echo e($key); ?>">
                                                        <label for="australia_<?php echo e($key); ?>" class="tg-label">
                                            ...
                                            <div class="d-none d-sm-block">
                                                <div class="tg-listing-box-view ml-10 d-flex">
                                                    <div class="list-switch-item">
                                                        <button @click="isListView = false" class="grid-view">
                                                    ...
                                                    <div class="list-switch-item ml-5">
                                                        <button @click="isListView = true" class="list-view active">
...
<?php $__env->startPush('style_section'); ?>
    <style>
        ...
        .tg-listing-card-actions .btn-sm {
            padding: 6px 12px;
            font-size: 12px;
            border-radius: 4px;
            white-space: nowrap;
        ...
        .tg-listing-card-actions .tg-listing-avai-btn.btn-sm {
        ...
        .tg-listing-card-actions .tg-listing-avai-btn.btn-sm:hover {
            background: var(--tg-theme-secondary);
        }

        .tg-listing-card-actions .tg-btn.btn-sm {
            padding: 6px 10px;
            font-size: 12px;
            display: flex;
            align-items: center;
        ...
        /* En mode liste (list-card-open) */
        .list-card.list-card-open .tg-listing-card-actions {
            flex-direction: row;
            justify-content: flex-end;
        }

        .list-card.list-card-open .tg-listing-card-actions .btn-sm {
            font-size: 13px;
            padding: 8px 15px;
        }
    </style>
