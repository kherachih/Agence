                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php else: ?>
                                                                <tr>
                                                                    <td colspan="5" class="text-center"><?php echo e(__('translate.No availability periods configured')); ?></td>
                                                                </tr>
                                                            <?php endif; ?>
                                                        </tbody>
                                                    </table>
                            ...
                            <div class="period-card" data-id="${period.id}">
                                <div class="period-header">
                                    <div>
                                        ...
                                        <span class="badge bg-info"><?php echo e(__("translate.Max People")); ?>: ${period.max_people}</span>
                                    </div>
