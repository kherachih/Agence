...
<div class="tg-listing-area tg-listing-su-spacing tg-grey-bg-2 pt-120 p-relative">
    <img class="tg-listing-su-shape d-none d-xl-block" src="<?php echo e(asset('frontend/assets/img/shape/air-plane-2.png')); ?>"
        alt="">
    <img class="tg-listing-su-shape-2 d-none d-xxl-block" src="<?php echo e(asset('frontend/assets/img/shape/bag.png')); ?>"
        alt="">
    <div class="container">
            ...
            <div class="col-lg-6">
                <div class="tg-listing-section-title-wrap text-center mb-40">
                    <h5 class="tg-section-su-subtitle su-subtitle-2 mb-15 wow fadeInUp" data-wow-delay=".4s"
                        ...
                        <?php echo e(getTranslatedValue($theme3_package, 'sub_title')); ?>

                    </h5>
                    <h2 class="tg-section-su-title text-capitalize wow fadeInUp mb-15" data-wow-delay=".5s"
                        data-wow-duration=".9s">
                        <?php echo e(getTranslatedValue($theme3_package, 'title')); ?>

                    </h2>
                </div>
            </div>
        </div>
        <?php if($theme3_popular_services->count() > 0): ?>
            <div class="row">

                <?php $__currentLoopData = $theme3_popular_services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="tg-listing-card-item tg-listing-su-card-item mb-25">
                            ...
                            <div class="tg-listing-card-content">
                                ...
                                <div class="tg-listing-card-price d-flex align-items-end justify-content-between">
                                    ...
                                    <div>
                                        <a href="<?php echo e(route('front.tourbooking.services.show', ['slug' => $service?->slug])); ?>" style="background-color: #be3144; color: white; padding: 6px 16px; border-radius: 6px; font-weight: 600; font-size: 14px; display: inline-block; transition: all 0.3s;">
                ...
                <div class="col-12">
                    <div class="text-center mt-15">
                        <a href="<?php echo e(getTranslatedValue($theme3_package, 'button_url')); ?>"
                            class="tg-btn tg-btn-transparent tg-btn-su-transparent">
                            <?php echo e(getTranslatedValue($theme3_package, 'button_text')); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme3/views/components/package.blade.php ENDPATH**/ ?>