					...
					<div class="crancy-wc__form--middle">
						...
						<div class="crancy-wc__form-inner">
							<div class="crancy-wc__logo">
								<a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset($general_setting->secondary_logo)); ?>" alt="#"></a>
							</div>
									...
									<div class="crancy-wc__form-top">
										...
										<?php if($has_super_admin): ?>
											<div class="crancy-wc__heading pd-btm-20">
												<h3 class="crancy-wc__form-title crancy-wc__form-title__one m-0"><?php echo e(__('translate.Login Here')); ?></h3>
												<p><?php echo e(__('translate.Welcome to Tourex Admin Panel')); ?></p>
											</div>
											<!-- Sign in Form -->
											<form class="crancy-wc__form-main" action="<?php echo e(route('admin.store-login')); ?>" method="post">
												<?php echo csrf_field(); ?>
												<div class="row">
													<div class="col-12">
														<!-- Form Group -->
														<div class="form-group">
															<div class="form-group__input">
																<input class="crancy-wc__form-input" type="email" name="email" placeholder="<?php echo e(__('translate.Email')); ?>">
															</div>
														</div>
													</div>
													<div class="col-12">
														...
														<div class="form-group">
															<div class="form-group__input">
																<input class="crancy-wc__form-input" placeholder="<?php echo e(__('translate.Password')); ?>" id="password-field" type="password" name="password">
												...
												<div class="form-group mg-top-30">
													<div class="crancy-wc__button">
														<button class="ntfmax-wc__btn" type="submit"><?php echo e(__('translate.Login Now')); ?></button>
													</div>
												</div>
										...
										<?php else: ?>
											<div class="crancy-wc__heading pd-btm-20">
												<h3 class="crancy-wc__form-title crancy-wc__form-title__one m-0"><?php echo e(__('translate.Create Admin Account')); ?></h3>
												<p><?php echo e(__('translate.Welcome to Tourex Admin Panel')); ?></p>
											</div>
											<!-- Sign in Form -->
											<form class="crancy-wc__form-main" action="<?php echo e(route('admin.store-register')); ?>" method="post">
												<?php echo csrf_field(); ?>
												...
												<div class="row">
													...
													<div class="col-12">
														...
														<div class="form-group">
															<div class="form-group__input">
																<input class="crancy-wc__form-input" type="text" name="name" placeholder="<?php echo e(__('translate.Name')); ?>">
															</div>
														</div>
													</div>
													...
													<div class="col-12">
														...
														<div class="form-group">
															<div class="form-group__input">
																<input class="crancy-wc__form-input" placeholder="<?php echo e(__('translate.Confirm Password')); ?>" id="confirm-password-field" type="password" name="password_confirmation">
												...
												<div class="form-group mg-top-30">
													<div class="crancy-wc__button">
														<button class="ntfmax-wc__btn" type="submit"><?php echo e(__('translate.Create Now')); ?></button>
													</div>
												</div>
...
<?php /**PATH D:\xampp\htdocs\archive\archive\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>