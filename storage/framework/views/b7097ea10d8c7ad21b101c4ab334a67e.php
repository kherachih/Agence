            ...
            <div class="col-lg-12">
                <div class="tg-location-section-title text-center mb-30">
                    <h5 class="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".9s">
                        <?php echo e(getTranslatedValue($theme5_blog, 'sub_title')); ?>

                    </h5>
                    <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                        <?php echo strip_tags(clean(getTranslatedValue($theme5_blog, 'title')), '<br>'); ?>

                    </h2>
                    <p class="text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">
                        <?php echo strip_tags(clean(getTranslatedValue($theme5_blog, 'description')), '<br>'); ?>
                        ...
                        <div class="tg-blog-content  p-relative">
                            ...
                            <div class="tg-blog-date">
                                <span class="mr-20"><i class="fa-light fa-calendar"></i>
                                    <?php echo e($firstBlog->created_at->format('jS M, Y')); ?></span>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="tg-blog-contents">
                                                <span
                                                    class="tg-blog-tag d-inline-block mb-10"><?php echo e($blog?->category?->name); ?></span>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme5/views/components/blog.blade.php ENDPATH**/ ?>