            ...
            <div class="row row__bscreen">
                ...
                <div class="col-xxl-3 col-md-6 col-12 mg-top-30">
                    <div class="crancy-ecom-card crancy-ecom-card__v2">
                        <div class="flex-main">
                            <span>
                                <?php echo $__env->make('svg.total_earning', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </span>
                            <div class="flex-1">
                                <div class="crancy-ecom-card__heading">
                                    <div class="crancy-ecom-card__icon">
                                        <h4 class="crancy-ecom-card__title"><?php echo e(__('translate.Total Booking')); ?> </h4>
                                    </div>
                                ...
                                <div class="crancy-ecom-card__content">
                                    <div class="crancy-ecom-card__camount">
                                        <div class="crancy-ecom-card__camount__inside">
                                            <h3 class="crancy-ecom-card__amount"><?php echo e($total_booking); ?></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xxl-3 col-md-6 col-12 mg-top-30">
                    <div class="crancy-ecom-card crancy-ecom-card__v2">
                        <div class="flex-main">
                            <span>
                                <?php echo $__env->make('svg.available_balance', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </span>
                            <div class="flex-1">
                                <div class="crancy-ecom-card__heading">
                                    <div class="crancy-ecom-card__icon">
                                        <h4 class="crancy-ecom-card__title"><?php echo e(__('translate.Transaction')); ?> </h4>
                                    </div>
                                ...
                                <div class="crancy-ecom-card__content">
                                    <div class="crancy-ecom-card__camount">
                                        <div class="crancy-ecom-card__camount__inside">
                                            <h3 class="crancy-ecom-card__amount"><?php echo e(currency($total_transaction)); ?></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="crancy-ecom-card crancy-ecom-card__v2">
                        <div class="flex-main">
                            ...
                            <div class="flex-1">
                                <div class="crancy-ecom-card__heading">
                                    <div class="crancy-ecom-card__icon">
                                        <h4 class="crancy-ecom-card__title"><?php echo e(__('translate.Support Ticket')); ?> </h4>
                                    </div>
                                ...
                                <div class="crancy-ecom-card__content">
                                    <div class="crancy-ecom-card__camount">
                                        <div class="crancy-ecom-card__camount__inside">
                                            <h3 class="crancy-ecom-card__amount"><?php echo e($support_tickets); ?></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xxl-3 col-md-6 col-12 mg-top-30">
                    <div class="crancy-ecom-card crancy-ecom-card__v2">
                        <div class="flex-main">
                            <span>
                                <?php echo $__env->make('svg.wishlist_icon', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </span>
                            <div class="flex-1">
                                <div class="crancy-ecom-card__heading">
                                    <div class="crancy-ecom-card__icon">
                                        <h4 class="crancy-ecom-card__title"><?php echo e(__('translate.Wishlist')); ?> </h4>
                                    </div>
                                ...
                                <div class="crancy-ecom-card__content">
                                    <div class="crancy-ecom-card__camount">
                                        <div class="crancy-ecom-card__camount__inside">
                                            <h3 class="crancy-ecom-card__amount"><?php echo e($wishlists); ?></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('user.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\archive\archive\resources\views/user/dashboard.blade.php ENDPATH**/ ?>