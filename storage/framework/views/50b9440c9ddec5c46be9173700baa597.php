                                ...
                                <table class="crancy-table__main crancy-table__main-v3 dataTable no-footer" id="dataTable">
                                    ...
                                    <thead class="crancy-table__head">
                                        <tr>
                                            ...
                                            <th class="crancy-table__column-2 crancy-table__h2 sorting">
                                                <?php echo e(__('translate.Period')); ?>
                                    ...
                                    <tbody class="crancy-table__body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="crancy-table__column-2 crancy-table__data-2">
                                                <small>
                                                    <?php if($promotion->starts_at): ?>
                                                    <?php echo e($promotion->starts_at->format('d M Y')); ?>

                                                    <?php else: ?>
                                                    <?php echo e(__('translate.Anytime')); ?>

                                                    <?php endif; ?>
                                                    -
                                                    <?php if($promotion->ends_at): ?>
                                                    <?php echo e($promotion->ends_at->format('d M Y')); ?>

                                                    <?php else: ?>
                                                    <?php echo e(__('translate.Ongoing')); ?>
