...
<?php $__env->startSection('title'); ?>
    <title><?php echo e(__('translate.Edit Destination')); ?></title>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('body-header'); ?>
    <h3 class="crancy-header__title m-0"><?php echo e(__('translate.Edit Destination')); ?></h3>
    <p class="crancy-header__text"><?php echo e(__('translate.Tour Booking')); ?> >> <?php echo e(__('translate.Edit Destination')); ?></p>
<?php $__env->stopSection(); ?>
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        <div class="crancy-dsinner">
                            <form action="<?php echo e(route('admin.tourbooking.destinations.update', $destination)); ?>" method="POST"
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="name"
                                                            id="name" value="<?php echo e(old('name', $destination->name)); ?>"
                                                            required>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label
                                                            class="crancy__item-label"><?php echo e(__('translate.Continent')); ?>*</label>
                                                        <select required class="crancy__item-input" name="continent_id" id="continent_id">
                                                            <option value=""><?php echo e(__('translate.Select Continent')); ?></option>
                                                            <?php $__currentLoopData = $continents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $continent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($continent->id); ?>" <?php echo e(old('continent_id', $destination->continent_id) == $continent->id ? 'selected' : ''); ?>>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input required class="crancy__item-input" type="text"
                                                            ...
                                                            value="<?php echo e(old('country', $destination->country)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input
                                                            placeholder="<?php echo e(__('translate.Separator by comma. Ex: 01 Tour, 02 Hotel')); ?>"
                                                            class="crancy__item-input" type="text" name="tags"
                                                            id="tags" value="<?php echo e(old('tags', $destination->tags)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <textarea class="crancy__item-input summernote" name="description" rows="6"><?php echo e(old('description', $destination->description)); ?></textarea>
                                                        ...
                                                        <div
                                                            ...
                                                            <label class="crancy__item-switch">
                                                                <input name="status" type="checkbox"
                                                                    <?php echo e(old('status', $destination->status) ? 'checked' : ''); ?>
                                                    ...
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        ...
                                                        <div
                                                            ...
                                                            <label class="crancy-image-video-upload__label" for="svg_img">
                                                                <img id="view_img_svg"
                                                                    src="<?php echo e(isset($destination) && $destination->svg_image ? asset('storage/' . $destination->svg_image) : asset($general_setting->placeholder_image)); ?>">
                                                    ...
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        ...
                                                        <div
                                                            ...
                                                            <label class="crancy-image-video-upload__label"
                                                                for="input-img1">
                                                                <img id="view_img"
                                                                    src="<?php echo e(isset($destination) && $destination->image ? asset('storage/' . $destination->image) : asset($general_setting->placeholder_image)); ?>">
                                                                <h4 class="crancy-image-video-upload__title">
                                                                    <?php echo e(__('translate.Click here to')); ?>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <textarea class="crancy__item-input summernote" name="meta_description" rows="3"><?php echo e(old('meta_description', $destination->meta_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12 mg-top-30">
                                        <button class="crancy-btn"
                                            type="submit"><?php echo e(__('translate.Update Destination')); ?>
...
<?php echo $__env->make('admin.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\archive\archive\Modules/TourBooking\resources/views/admin/destinations/edit.blade.php ENDPATH**/ ?>