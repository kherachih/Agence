<!-- footer-area-start -->
    <footer>
        <div class="tg-footer-area tg-footer-su-wrapper tg-footer-su-2-wrapper pt-130 include-bg" data-background="<?php echo e(asset('frontend/assets/img/shape/home-1-footer-bg.jpeg')); ?>">
           <div class="container">
                            ...
                            <div class="tg-footer-widget mb-40">
                                ...
                                <div class="tg-footer-social">
                                    ...
                                    <?php if($footer->linkedin): ?>
                                        <a href="<?php echo e($footer->linkedin); ?>"><i class="fa-brands fa-linkedin-in"></i></a>
                                    <?php endif; ?>
    ...
    <!-- footer-area-end -->
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme4/views/components/footer.blade.php ENDPATH**/ ?>