...
<?php if($theme2_service_type->count() > 0): ?>
                    ...
                    <div class="tg-booking-form-wrap tg-booking-form-space">
                        <div class="tg-booking-form-tabs">
                            <div class="nav nav-tab justify-content-center" id="nav-tab" role="tablist">
                                <?php $__currentLoopData = $theme2_service_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $service_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button class="<?php echo \Illuminate\Support\Arr::toCssClasses(['nav-links', 'active' => $loop->first]); ?>" class=""
                                        id="service_type-<?php echo e($service_type->id); ?>-tab" data-bs-toggle="tab"
                                        data-bs-target="#service_type-<?php echo e($service_type->id); ?>" type="button"
                                        role="tab" aria-controls="service_type-<?php echo e($service_type->id); ?>"
                                        aria-selected="false">
                                        <span class="borders"></span>
                                        <span class="icon">
                                            <?php if($service_type->image): ?>
                                                <img width="19" height="12"
                                                    src="<?php echo e(asset($service_type->image)); ?>">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <?php $__currentLoopData = $theme2_service_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $service_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['tab-pane fade', 'show active' => $loop->first]); ?>" id="service_type-<?php echo e($service_type->id); ?>"
                                    role="tabpanel" aria-labelledby="service_type-<?php echo e($service_type->id); ?>-tab"
                                    tabindex="0">
                                        ...
                                        <form x-data="bookingForm()" @submit.prevent="submitForm">
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="tg-booking-form-title mb-5"><?php echo e(__('translate.Destinations:')); ?></span>
                                                    ...
                                                    <div
                                                        ...
                                                        <ul class="scrool-bar scrool-height pr-5">
                                                            <?php $__currentLoopData = $theme2_destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $destination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li
                                                ...
                                                <div class="tg-booking-form-parent-inner mr-15 mb-15">
                                                    <span
                                                        class="tg-booking-form-title mb-5"><?php echo e(__('translate.Check in:')); ?></span>
                                                ...
                                                <div class="tg-booking-form-parent-inner mr-15 mb-15">
                                                    <span
                                                        class="tg-booking-form-title mb-5"><?php echo e(__('translate.Check Out:')); ?></span>
                                                    <div class="tg-booking-add-input-date p-relative">
                                                ...
                                                <div
                                                    class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-15">
                                                    <span
                                                        class="tg-booking-form-title mb-5"><?php echo e(__('translate.Guest:')); ?></span>
                                                    <div class="tg-booking-add-input-field tg-booking-quantity-toggle">
                                                        <div>
                                                    ...
                                                    <div
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <span
                                                                    class="mr-20"><?php echo e(__('translate.Rooms')); ?></span>
                                                            ...
                                                            <li>
                                                                <span
                                                                    class="mr-20"><?php echo e(__('translate.Adults')); ?></span>
                                                                <div class="tg-booking-quantity-item">
                                                            ...
                                                            <li>
                                                                <span
                                                                    class="mr-20"><?php echo e(__('translate.Children')); ?></span>
                                                                <div class="tg-booking-quantity-item">
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme2/views/components/booking-form.blade.php ENDPATH**/ ?>