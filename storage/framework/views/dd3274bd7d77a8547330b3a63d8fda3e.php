...
<html class="no-js" lang="zxx">
	<head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('global/datatable/dataTables.bootstrap4.min.css')); ?>">
		...
		<link rel="stylesheet" href="<?php echo e(asset('backend/css/enrollment.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('backend/css/overview.css')); ?>">
	...
	<body id="crancy-dark-light">
			...
			<div class="crancy-smenu" id="CrancyMenu">
				...
				<div class="admin-menu">
					...
					<div class="logo crancy-sidebar-padding pd-right-0">
						<a class="crancy-logo" href="<?php echo e(route('user.dashboard')); ?>">
							...
							<div class="crancy-header__inner">
								<div class="crancy-header__middle">
									...
									<div class="crancy-header__heading">
                                        <?php echo $__env->yieldContent('body-header'); ?>
												...
												<div class="crancy-header__right">
                                                    ...
                                                    <?php if($auth_user->instructor_joining_request == 'approved'): ?>
                                                        <div class="profile-switcher-wrapper d-md-flex d-none gap-3 align-items-center">
                                                            <p class="text"><?php echo e(__('translate.Switch to Agency Dashboard')); ?></p>
                                                    ...
                                                    <?php else: ?>
                                                        <div class="profile-switcher-wrapper d-md-flex d-none gap-3 align-items-center">
                                                            <p class="text"><?php echo e(__('translate.Create a agency')); ?></p>
                                                            <label class="custom-switch join_as_instructor">
                                                                <input type="checkbox" <?php echo e(Route::is('user.create-agency') ? 'checked' : ''); ?>>
                                                                <span class="slider"></span>
                                                            </label>
                                                        </div>
                                                    <?php endif; ?>
													...
													<div class="crancy-header__options">
														...
														<div class="crancy-header__single">
															<a target="_blank" class="crancy-header__blink" href="<?php echo e(route('home')); ?>">
													...
													<!-- Header Author -->
													<div class="crancy-header__single">
														<a href="<?php echo e(route('user.edit-profile')); ?>"><div class="crancy-header__author-img">

															<img src="<?php echo e($auth_user->image ? asset($auth_user->image) : asset($general_setting->default_avatar)); ?>" alt="#">
																...
																<ul class="crancy-dmenu">
																	<li>
																		<a href="<?php echo e(route('user.edit-profile')); ?>">
																			...
																			<?php echo e(__('translate.My Profile')); ?>
        ...
        <script src="<?php echo e(asset('global/datatable/jquery.dataTables.min.js')); ?>"></script>
		<script src="<?php echo e(asset('global/datatable/dataTables.bootstrap4.min.js')); ?>"></script>
            ...
            (function($) {
                ...
                $(document).ready(function () {
                    ...
                    $(".switch_to_instructor").on("change", function(){
                        window.location = `<?php echo e(route('agency.dashboard')); ?>`

                    })

                    $(".join_as_instructor").on("change", function(){
                        window.location = `<?php echo e(route('user.create-agency')); ?>`
...
<?php /**PATH D:\xampp\htdocs\archive\archive\resources\views/user/master_layout.blade.php ENDPATH**/ ?>