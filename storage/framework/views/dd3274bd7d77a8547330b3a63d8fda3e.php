												...
												<div class="crancy-header__single">
													<a href="<?php echo e(route('user.edit-profile')); ?>">
														<div class="crancy-header__author-img">
															...
															<img src="<?php echo e($auth_user->image ? asset($auth_user->image) : asset($general_setting->default_avatar)); ?>"
																alt="#">
...
</html><?php /**PATH D:\xampp\htdocs\archive\archive\resources\views/user/master_layout.blade.php ENDPATH**/ ?>