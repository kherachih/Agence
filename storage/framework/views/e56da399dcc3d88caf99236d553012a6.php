...
<?php $__env->startSection('title'); ?>
    <title><?php echo e(__('translate.Continents')); ?></title>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('body-header'); ?>
    <h3 class="crancy-header__title m-0"><?php echo e(__('translate.Continents')); ?></h3>
    <p class="crancy-header__text"><?php echo e(__('translate.Tour Booking')); ?> >> <?php echo e(__('translate.Continents')); ?></p>
<?php $__env->stopSection(); ?>
                            ...
                            <div class="crancy-table crancy-table--v3 mg-top-30">
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <h4 class="crancy-product-card__title"><?php echo e(__('translate.All Continents')); ?></h4>
                                        <div class="d-flex align-items-center gap-2">
                                            <a href="<?php echo e(route('admin.tourbooking.continents.create')); ?>"
                                                class="crancy-btn"><i class="fa fa-plus"></i>
                                                <?php echo e(__('translate.Add New Continent')); ?></a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $continents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $continent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr class="odd">
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <?php echo e($continent->id); ?></td>
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <?php if($continent->image): ?>
                                                            <img src="<?php echo e(asset('storage/' . $continent->image)); ?>"
                                                                alt="<?php echo e($continent->name); ?>" class="img-thumbnail"
                                                                width="50">
                                                        <?php else: ?>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <?php echo e($continent->name); ?></td>
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <?php echo e($continent->code ?? '-'); ?></td>
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <span class="badge badge-info"><?php echo e($continent->destinations_count); ?></span>
                                                    </td>
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <?php if($continent->status): ?>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <?php echo e($continent->created_at->format('d M, Y')); ?>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <label class="crancy__item-switch" data-bs-toggle="tooltip"
                                                            ...
                                                            <input onClick="manageStatus(<?php echo e($continent->id); ?>)"
                                                                name="status" type="checkbox"
                                                                <?php echo e($continent->status == 1 ? 'checked' : ''); ?>>
                                                            <span
                                                                class="crancy__item-switch--slide crancy__item-switch--round"></span>
                                                        </label>

                                                        <a href="<?php echo e(route('admin.tourbooking.continents.edit', $continent)); ?>"
                                                            class="crancy-action__btn crancy-action__edit crancy-btn">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a onclick="itemDeleteConfrimation(<?php echo e($continent->id); ?>)"
...
<?php $__env->startPush('js_section'); ?>
    <script>
        ...
        function itemDeleteConfrimation(id) {
            $("#item_delect_confirmation").attr("action", '<?php echo e(url('admin/tourbooking/continents')); ?>' + "/" + id)
        }
        ...
        function manageStatus(id) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('admin.tourbooking.continents.update-status', ':id')); ?>".replace(':id', id),
...
<?php echo $__env->make('admin.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\archive\archive\Modules/TourBooking\resources/views/admin/continents/index.blade.php ENDPATH**/ ?>