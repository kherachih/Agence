...
<?php if($theme3_hero): ?>
    ...
    <div class="mobile-booking-app">
        ...
        <div class="mobile-header">
            <div class="header-content">
                ...
                <div class="app-title">
                    <h1>Tourex</h1>
                    <p class="subtitle"><?php echo e(__('translate.Your Travel Companion')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div x-data="mobileBookingApp()" x-init="initApp" class="booking-container">
            ...
            <div x-show="currentStep === 1" x-transition:enter="animate__animated animate__fadeIn" class="step step-1">
                <div class="welcome-content">
                    ...
                    <h2 class="welcome-title"><?php echo e(__('translate.Plan Your Perfect Trip')); ?></h2>
                    <p class="welcome-description"><?php echo e(__('translate.Get ready for an unforgettable adventure! Find and book the best tours with just a few taps.')); ?></p>
                    
                    <div class="quick-features">
                        <div class="feature">
                            <i class="fas fa-map-marked-alt"></i>
                            <span><?php echo e(__('translate.Discover Destinations')); ?></span>
                        </div>
                        <div class="feature">
                            <i class="fas fa-calendar-alt"></i>
                            <span><?php echo e(__('translate.Flexible Dates')); ?></span>
                        </div>
                        <div class="feature">
                            <i class="fas fa-users"></i>
                            <span><?php echo e(__('translate.Group Bookings')); ?></span>
                        </div>
                    </div>

                    <button @click="currentStep = 2" class="primary-button">
                        <?php echo e(__('translate.Get Started')); ?>
            ...
            <div x-show="currentStep === 2" x-transition:enter="animate__animated animate__fadeIn" class="step step-2">
                <div class="step-header">
                    ...
                    <h3 class="step-title"><?php echo e(__('translate.Where do you want to go?')); ?></h3>
                </div>
                ...
                <div class="destination-search">
                    <div class="search-input-wrapper">
                        ...
                        <input 
                            type="text" 
                            x-model="searchQuery" 
                            placeholder="<?php echo e(__('translate.Search destinations...')); ?>"
                            class="search-input"
                        >
                    </div>
                </div>
                    ...
                    <template x-for="destination in filteredDestinations" :key="destination.id">
                        ...
                        >
                            ...
                            <div class="destination-info">
                                ...
                                <p class="destination-services"><?php echo e(__('translate.Available tours')); ?></p>
                            </div>
            ...
            <div x-show="currentStep === 3" x-transition:enter="animate__animated animate__fadeIn" class="step step-3">
                <div class="step-header">
                    ...
                    <h3 class="step-title"><?php echo e(__('translate.Select Your Tour')); ?></h3>
                    <p class="step-subtitle"><?php echo e(__('translate.Choose from amazing experiences')); ?></p>
                </div>
                ...
                <div class="tour-types">
                    ...
                    >
                        ...
                        <span><?php echo e(__('translate.Adventure')); ?></span>
                    </div>
                    <div 
                    ...
                    >
                        ...
                        <span><?php echo e(__('translate.Cultural')); ?></span>
                    </div>
                    <div 
                    ...
                    >
                        ...
                        <span><?php echo e(__('translate.Relaxation')); ?></span>
                    </div>
                    <div 
                    ...
                    >
                        <i class="fas fa-users"></i>
                        <span><?php echo e(__('translate.Family')); ?></span>
                    </div>
                </div>
            ...
            <div x-show="currentStep === 4" x-transition:enter="animate__animated animate__fadeIn" class="step step-4">
                <div class="step-header">
                    ...
                    <h3 class="step-title"><?php echo e(__('translate.Who is Travelling?')); ?></h3>
                </div>
                ...
                <div class="guest-selection">
                    <div class="guest-type">
                        <div class="guest-info">
                            ...
                            <span><?php echo e(__('translate.Adults')); ?></span>
                            <small><?php echo e(__('translate.Age 18+')); ?></small>
                        </div>
                    ...
                    <div class="guest-type">
                        <div class="guest-info">
                            ...
                            <span><?php echo e(__('translate.Children')); ?></span>
                            <small><?php echo e(__('translate.Age 0-17')); ?></small>
                        </div>
                        <div class="guest-quantity">
            ...
            <div x-show="currentStep === 5" x-transition:enter="animate__animated animate__fadeIn" class="step step-5">
                <div class="step-header">
                    ...
                    <h3 class="step-title"><?php echo e(__('translate.Number of Rooms')); ?></h3>
                    <p class="step-subtitle"><?php echo e(__('translate.Select rooms based on your needs')); ?></p>
                </div>

                <div class="room-selection">
                    <div class="room-info">
                        <i class="fas fa-bed"></i>
                        <span><?php echo e(__('translate.Rooms')); ?></span>
                    </div>
            ...
            <div x-show="currentStep === 6" x-transition:enter="animate__animated animate__fadeIn" class="step step-6">
                <div class="step-header">
                    ...
                    <h3 class="step-title"><?php echo e(__('translate.Select Date')); ?></h3>
                </div>
                ...
                <div class="date-selection">
                    ...
                    <div class="calendar">
                        <div class="calendar-header">
                            <div class="day"><?php echo e(__('translate.Su')); ?></div>
                            <div class="day"><?php echo e(__('translate.Mo')); ?></div>
                            <div class="day"><?php echo e(__('translate.Tu')); ?></div>
                            <div class="day"><?php echo e(__('translate.We')); ?></div>
                            <div class="day"><?php echo e(__('translate.Th')); ?></div>
                            <div class="day"><?php echo e(__('translate.Fr')); ?></div>
                            <div class="day"><?php echo e(__('translate.Sa')); ?></div>
                        </div>
                ...
                <div class="step-footer">
                    <button 
                        ...
                        class="primary-button"
                    >
                        <?php echo e(__('translate.Search Tours')); ?>
            ...
            <div x-show="currentStep === 7" x-transition:enter="animate__animated animate__fadeIn" class="step step-7">
                <div class="loading-content">
                    ...
                    <h3><?php echo e(__('translate.Searching for perfect tours...')); ?></h3>
                    <p><?php echo e(__('translate.Finding the best options for you')); ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <script>
            function mobileBookingApp() {
                return {
                    ...
                    destinations: <?php echo json_encode($theme3_destinations); ?>,
                    ...
                    loadCalendar() {
                        const monthNames = [
                            "<?php echo e(__('translate.January')); ?>", "<?php echo e(__('translate.February')); ?>",
                            "<?php echo e(__('translate.March')); ?>", "<?php echo e(__('translate.April')); ?>",
                            "<?php echo e(__('translate.May')); ?>", "<?php echo e(__('translate.June')); ?>",
                            "<?php echo e(__('translate.July')); ?>", "<?php echo e(__('translate.August')); ?>",
                            "<?php echo e(__('translate.September')); ?>", "<?php echo e(__('translate.October')); ?>",
                            "<?php echo e(__('translate.November')); ?>", "<?php echo e(__('translate.December')); ?>"
                        ];
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?><?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme3/views/components/mobile-booking-app.blade.php ENDPATH**/ ?>