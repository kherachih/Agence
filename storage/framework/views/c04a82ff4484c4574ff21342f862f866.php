...
<?php if($partners->count() > 0): ?>
    ...
    <div class="tg-brand-area tg-grey-bg pb-80 p-relative z-index-1">
        <img class="tg-brand-shape" src="<?php echo e(asset('frontend/assets/img/shape/pyramid-2.png')); ?>" alt="">
        <img class="tg-brand-shape-2" src="<?php echo e(asset('frontend/assets/img/shape/hill.png')); ?>" alt="">
        <div class="container">
            <div class="row">
    ...
    <!-- brands-area-end -->
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme2/views/components/partner.blade.php ENDPATH**/ ?>