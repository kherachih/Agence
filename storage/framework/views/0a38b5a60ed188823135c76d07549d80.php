...
<!-- banner-area-start -->
<div class="tg-banner-area tg-banner-5-space fix  include-bg" data-background="<?php echo e(asset(getSingleImage($theme7_banner, 'background_image'))); ?>">
    <div class="container">
                ...
                <div class="tg-banner-5-content text-center">
                    <h2 class="tg-banner-5-title mb-15 wow fadeInUp" data-wow-delay=".4s" data-wow-duration="1s">
                        <span class="p-relative">
                            <?php echo e(getTranslatedValue($theme7_banner, 'sub_title')); ?>
                        ...
                        <span>
                            <?php echo e(getTranslatedValue($theme7_banner, 'title')); ?>

                        </span>
                    </h2>
                    <div class="tg-banner-5-btn text-center wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                        <a href="<?php echo e(getTranslatedValue($theme7_banner, 'button_url')); ?>" class="tg-btn tg-btn-switch-animation">
                            <span class="d-flex align-items-center justify-content-center">
                                <span class="btn-text">
                                    <?php echo e(getTranslatedValue($theme7_banner, 'button_text')); ?>
...
<!-- banner-area-end -->
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme7/views/components/banner.blade.php ENDPATH**/ ?>