                            ...
                            <div class="crancy-table crancy-table--v3 mg-top-30">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th><?php echo e(__('translate.Date Depart')); ?></th>
                                            <td><?php echo e($quote->date_depart ? \Carbon\Carbon::parse($quote->date_depart)->format('d M Y') : 'N/A'); ?></td>
                                        </tr>
                                        <tr>
                                            <th><?php echo e(__('translate.Date Retour')); ?></th>
                                            <td><?php echo e($quote->date_retour ? \Carbon\Carbon::parse($quote->date_retour)->format('d M Y') : 'N/A'); ?></td>
                                        </tr>
                                        <tr>
