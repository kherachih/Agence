...
<div class="tg-listing-area pt-140 pb-105 p-relative z-index-9">
    <img class="tg-listing-3-shape d-none d-xl-block" src="<?php echo e(asset('frontend/assets/img/shape/tree.png')); ?>"
        alt="">
    <div class="container">
        <div class="row align-items-end">
            <div class="col-lg-9">
                <div class="tg-location-section-title mb-40">
                    <h5 class="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                        <?php echo e(getTranslatedValue($theme5_tour_package, 'sub_title')); ?>

                    </h5>
                    <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">
                        <?php echo strip_tags(clean(getTranslatedValue($theme5_tour_package, 'title')), '<br>'); ?>
            ...
            <div class="col-lg-3">
                <div class="tg-location-3-btn text-end wow fadeInUp mb-40" data-wow-delay=".6s" data-wow-duration=".9s">
                    <a href="<?php echo e(getTranslatedValue($theme5_tour_package, 'button_url')); ?>"
                        class="tg-btn tg-btn-gray tg-btn-switch-animation">
                        <span class="d-flex align-items-center justify-content-center">
                            <span class="btn-text"><?php echo e(getTranslatedValue($theme5_tour_package, 'button_text')); ?></span>
        ...
        <?php if($theme5_popular_services->count() > 0): ?>
            <div class="row">
                <?php $__currentLoopData = $theme5_popular_services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".<?php echo e($key + 3); ?>s"
                        ...
                        <div class="tg-listing-card-item tg-listing-3-card-item mb-25">
                            <div class="tg-listing-card-thumb tg-listing-2-card-thumb mb-15 fix p-relative">
                                <a href="<?php echo e(route('front.tourbooking.services.show', ['slug' => $service?->slug])); ?>">
                                    ...
                                    <?php if($service?->discount_price): ?>
                                        <span class="tg-listing-item-price-discount shape-2"
                                            style="background-image: url('<?php echo e(asset('frontend/assets/img/shape/offter.png')); ?>')">
                                            <?php echo e(__('translate.Sale offer')); ?>
                                ...
                                <div class="tg-listing-2-price"
                                    style="background-image: url('<?php echo e(asset('frontend/assets/img/shape/price-shape2.png')); ?>')">
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme5/views/components/tour-package.blade.php ENDPATH**/ ?>