<!-- footer-area-start -->
<footer>
    <div class="tg-footer-area pt-130 include-bg" data-background="<?php echo e(asset('frontend/assets/img/shape/home-6-footer-bg.jpeg')); ?>">
        <div class="container">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="tg-footer-widget mb-40">
                            <div class="tg-footer-logo mb-20">
                                <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset($general_setting->logo)); ?>" alt=""></a>
                            </div>
...
<!-- footer-area-end -->
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme6/views/components/footer.blade.php ENDPATH**/ ?>