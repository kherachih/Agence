...
<?php if($theme3_hero): ?>
    ...
    <div class="tg-hero-area tg-hero-tu-wrapper include-bg"
        data-background="<?php echo e(asset(getSingleImage($theme3_hero, 'background_image'))); ?>">
        <div class="container">
                    ...
                    <div class="tg-hero-content text-center">
                        <div class="tg-hero-title-box mb-30">
                            <h2 class="tg-hero-title wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".5s">
                                <?php echo e(getTranslatedValue($theme3_hero, 'title')); ?>

                            </h2>
                            <h3 class="tg-hero-tu-title wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".7s">
                                <?php echo e(getTranslatedValue($theme3_hero, 'sub_title')); ?>
                        ...
                        <div class="tg-hero-tu-avatar-wrap d-flex justify-content-center flex-wrap align-items-center wow fadeInUp"
                            ...
                            <span class="tg-hero-tu-avatar d-inline-block mr-10 mb-15">
                                <img src="<?php echo e(asset(getSingleImage($theme3_hero, 'peoples_image'))); ?>" alt="">
                            </span>
                            <span class="tg-hero-tu-avatar-text d-inline-block mr-10 p-relative mb-15">
                                <?php echo strip_tags(clean(getTranslatedValue($theme3_hero, 'description')), '<br>'); ?>
                            ...
                            <form x-data="bookingForm()" @submit.prevent="submitForm">
                                <div class="tg-booking-form-input-group d-flex align-items-end justify-content-between">
                                    <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-10">
                                        <span class="tg-booking-form-title"><?php echo e(__('translate.Destinations')); ?></span>
                                        <div class="tg-booking-add-input-field tg-booking-quantity-toggle">
                                            ...
                                            <span x-show="destination" x-text="destination"
                                                ...
                                                <?php echo e(__('translate.Where to ?')); ?>
                                        ...
                                        <div class="tg-booking-form-location-list tg-booking-quantity-active">
                                            <ul class="scrool-bar scrool-height pr-5">
                                                <?php $__currentLoopData = $theme3_destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $destination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li
                                                        @click="selectDestination(`<?php echo e($destination->id); ?>`, `<?php echo e($destination->name); ?>`, $event)">
                                    ...
                                    <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-10">
                                        <span class="tg-booking-form-title"><?php echo e(__('translate.Month:')); ?></span>
                                    ...
                                    <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-10">
                                        ...
                                        <div
                                            ...
                                            <div class="text-right pb-10 pr-15" style="border-top: 1px solid #efefef; margin-top:10px;">
                                                <span @click="closeDropdown($event)" style="color: #be3144; font-weight: 600; cursor: pointer; padding: 5px 10px; display: inline-block;"><?php echo e(__('translate.Done')); ?></span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme3/views/components/hero.blade.php ENDPATH**/ ?>