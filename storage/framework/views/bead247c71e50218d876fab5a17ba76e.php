...
<div class="tg-listing-area pt-135 pb-105 tg-grey-bg">
    <div class="container">
            ...
            <div class="col-lg-9">
                <div class="tg-location-section-title mb-40">
                    <h5 class="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                        <?php echo e(getTranslatedValue($theme7_tour_package, 'sub_title')); ?>

                    </h5>
                    <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">
                        <?php echo strip_tags(clean(getTranslatedValue($theme7_tour_package, 'title')), '<br>'); ?>

                    </h2>
                </div>
            </div>
            <?php if(getTranslatedValue($theme7_tour_package, 'show_navigation') == '1'): ?>
                <div class="col-lg-3">
        ...
        <?php if($theme7_popular_services && $theme7_popular_services->count() > 0): ?>
            <div class="row">
                <div class="col-12">
                    <div class="swiper-container tg-listing-slider-2 p-relative fix">
                        <div class="swiper-wrapper">
                            <?php $__currentLoopData = $theme7_popular_services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide">
                                    <div class="tg-listing-card-item tg-listing-5-card-item mb-25">
                                        <div class="tg-listing-card-thumb tg-listing-2-card-thumb mb-15 fix p-relative">
                                            <a
                                                ...
                                                <?php if($service?->is_new == 1): ?>
                                                    <span class="tg-listing-item-price-discount shape"
                                                        style="background-image: url('<?php echo e(asset('frontend/assets/img/shape/price-shape-2.png')); ?>')">
                                                        <?php echo e(__('translate.New')); ?>
                                                ...
                                                <?php if($service?->is_featured == 1): ?>
                                                    <span class="tg-listing-item-price-discount offer-btm shape-3"
                                                        ...
                                                        <?php echo e(__('translate.Featured')); ?>
                                            ...
                                            <?php if($service?->destination?->name): ?>
                                                <div class="tg-listing-2-price">
                                                    ...
                                                    <span class="text"><?php echo e($service?->destination?->name); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="tg-listing-card-content p-relative">
                                            ...
                                            <div
                                                ...
                                                <a class="tg-listing-avai-btn"
                                                    href="<?php echo e(route('front.tourbooking.services.show', ['slug' => $service?->slug])); ?>">
                                                    <?php echo e(__('translate.View Details')); ?>

                                                </a>
                                                <div class="tg-listing-card-price d-flex align-items-center">
                                                    <span class="price"><?php echo e(currency($service?->full_price)); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme7/views/components/tour-package.blade.php ENDPATH**/ ?>