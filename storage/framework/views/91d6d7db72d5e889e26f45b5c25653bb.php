<footer>
    <div class="tg-footer-area tg-footer-space include-bg" data-background="<?php echo e(asset('frontend/assets/img/shape/home-1-footer-bg.jpeg')); ?>">
        <div class="container">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="tg-footer-widget mb-40">
                            <div class="tg-footer-logo mb-20">
                                <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset($general_setting->footer_logo)); ?>" alt=""></a> 
                            </div>
                            ...
                            <div class="tg-footer-form mb-30">
                                <form action="<?php echo e(route('store-newsletter')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <input type="email" placeholder="<?php echo e(__('translate.Enter your mail')); ?>">
                            ...
                            <div class="tg-footer-social">
                                ...
                                <a href="<?php echo e($footer->linkedin); ?>"><i class="fa-brands fa-pinterest-p"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="tg-footer-widget tg-footer-info mb-40">
                            ...
                            <ul>
                                ...
                                <?php if($footer->phone): ?>
                                <li>
                                    <a class="d-flex" href="tel:<?php echo e($footer->phone); ?>">
                                        <span class="mr-15">
                                ...
                                <li class="d-flex">
                                    ...
                                    <p class="mb-0">
                                        <?php echo e($footer->working_hours); ?>
...
<!-- End Footer Section -->
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme2/views/components/footer.blade.php ENDPATH**/ ?>