...
<?php $__env->startPush('style_section'); ?>
    <style>
        ...
        .tg-continent-icon {
            width: 55px;
            height: 55px;
            background: linear-gradient(135deg, #B42E40 0%, #8a2333 100%);
            border-radius: 10px;
            display: flex;
            align-items: center;
        ...
        .tg-destination-tours {
            background: rgba(180, 46, 64, 0.95);
            color: #ffffff;
            padding: 5px 12px;
            border-radius: 20px;
            font-size: 12px;
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            continentItems.forEach(item => {
                ...
                // Click to toggle (works on mobile + desktop fallback)
                header.addEventListener('click', function () {
                    toggleContinent(item);
                });

                // Hover to auto-expand on desktop only
