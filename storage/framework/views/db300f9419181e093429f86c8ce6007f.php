...
<div class="tg-booking-form-area p-relative z-index-1">
    <img class="tg-booking-4-shape d-none d-lg-block" src="<?php echo e(asset('frontend/assets/img/shape/hill-4.png')); ?>"
        alt="shape">
    <img class="tg-booking-4-shape-2 d-none d-lg-block" src="<?php echo e(asset('frontend/assets/img/shape/pyramid-3.png')); ?>"
        alt="shape">
    <div class="container">
        <div class="row">
            <div class="col-12">
                            ...
                            <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-15">
                                ...
                                <div class="tg-booking-form-location-list tg-booking-quantity-active">
                                    <ul class="scrool-bar scrool-height pr-5">
                                        <?php $__currentLoopData = $theme6_destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $destination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme6/views/components/booking-form.blade.php ENDPATH**/ ?>