...
<?php $__env->startSection('body-header'); ?>
    ...
    <p class="crancy-header__text"><?php echo e(__('translate.Manage Agency')); ?> >> <?php echo e($title); ?></p>
<?php $__env->stopSection(); ?>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            <?php echo e(html_decode($user->agency_name)); ?></h4>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            <?php echo e(html_decode($user->email)); ?></h4>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            <?php echo e(html_decode($user->phone)); ?></h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <div
                                                            ...
                                                            <label class="crancy__item-switch">
                                                                <input onClick="manageStatus(<?php echo e($user->id); ?>)"
                                                                    name="status" type="checkbox"
                                                                    <?php echo e($user->status == 'enable' ? 'checked' : ''); ?>>
                                                                <span
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="<?php echo e(route('admin.seller-show', $user->id)); ?>"
                                                            class="crancy-btn"><i class="fas fa-eye"></i>
                                                            <?php echo e(__('translate.Show')); ?></a>

                                                        <a onclick="itemDeleteConfrimation(<?php echo e($user->id); ?>)"
...
<?php echo $__env->make('admin.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\archive\archive\resources\views/admin/seller/seller_list.blade.php ENDPATH**/ ?>