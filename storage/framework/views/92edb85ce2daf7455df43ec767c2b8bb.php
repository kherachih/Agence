...
<?php if($theme4_hero): ?>
    ...
    <div class="tg-hero-area tg-hero-tu-2-wrapper include-bg"
        data-background="<?php echo e(asset(getSingleImage($theme4_hero, 'background_image'))); ?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="tg-hero-3-content text-center mb-40">
                        <h4 class="tg-hero-3-subtitle wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".6s">
                            <?php echo e(getTranslatedValue($theme4_hero, 'sub_title')); ?>

                        </h4>
                        <h2 class="tg-hero-3-title wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".6s">
                            <?php echo e(getTranslatedValue($theme4_hero, 'title')); ?>
                                ...
                                <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-15">
                                    ...
                                    <div class="tg-booking-form-location-list tg-booking-quantity-active">
                                        <ul class="scrool-bar scrool-height pr-5">
                                            <?php $__currentLoopData = $theme4_destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $destination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li
                                    ...
                                    <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="swiper-slide">
                                            <div class="tg-brand-items">
                                                <a href="<?php echo e($partner?->link ?? '#'); ?>"><img
                                                        src="<?php echo e($partner?->logo); ?>" alt="logo">
                                                </a>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme4/views/components/hero.blade.php ENDPATH**/ ?>