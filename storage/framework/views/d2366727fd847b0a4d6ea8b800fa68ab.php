<?php
    ...
    $theme3_testimonial = getContent('theme3_testimonial.content', true);
...
<?php if($testimonials->count() > 0): ?>
    ...
    <div class="tg-testimonial-area tg-testimonial-su-wrap p-relative pt-160 pb-50">
        <img class="tg-testimonial-su-shape d-none d-xxl-block" src="<?php echo e(asset('frontend/assets/img/shape/hill-2.png')); ?>" alt="">
        <img class="tg-testimonial-su-shape-2 d-none d-lg-block" src="<?php echo e(asset('frontend/assets/img/shape/parasut-2.png')); ?>"
            alt="">
        <div class="container">
                ...
                <div class="col-xl-10">
                    <div class="tg-testimonial-4-wrap">
                                        ...
                                        <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="swiper-slide">
                                                <div class="tg-testimonial-4-slider-thumb">
                                                    <img src="<?php echo e($testimonial?->image); ?>" alt="">
                                                </div>
                                            </div>
                        ...
                        <div class="swiper-container tg-testimonial-4-slide-active p-relative fix pb-20">
                            ...
                            <?php if(getTranslatedValue($theme3_testimonial, 'show_navigation') == '1'): ?>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme3/views/components/testimonial.blade.php ENDPATH**/ ?>