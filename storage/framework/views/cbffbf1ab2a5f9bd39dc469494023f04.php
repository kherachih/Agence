<?php $__env->startSection('title'); ?>
    <title><?php echo e(__('translate.Agency Support')); ?></title>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('body-header'); ?>
    <h3 class="crancy-header__title m-0"><?php echo e(__('translate.Agency Support')); ?></h3>
    <p class="crancy-header__text"><?php echo e(__('translate.Dashboard')); ?> >> <?php echo e(__('translate.Agency Support')); ?></p>
<?php $__env->stopSection(); ?>
                                ...
                                <div class="crancy-customer-filter">
                                    <div class="crancy-customer-filter__single crancy-customer-filter__single--csearch d-flex items-center justify-between create_new_btn_box">
                                        <div class="crancy-header__form crancy-header__form--customer create_new_btn_inline_box">
                                            <h4 class="crancy-product-card__title"><?php echo e(__('translate.Agency Support')); ?></h4>

                                            <a href="<?php echo e(route('user.agency-support.create')); ?>" class="crancy-btn "><span>
                                        ...
                                        <tbody class="crancy-table__body">
                                            <?php $__currentLoopData = $support_tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $support_ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title"><?php echo e(html_decode($support_ticket?->service?->title)); ?></h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="<?php echo e(route('user.agency-support.show', $support_ticket->ticket_id)); ?>" class="crancy-btn"><i class="far fa-message"></i> <?php echo e(__('translate.Chat')); ?></a>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('user.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\archive\archive\Modules/SupportTicket\resources/views/servicequery/student/index.blade.php ENDPATH**/ ?>