                ...
                <div class="tg-header-left">
                    <div class="tgmenu__wrap d-flex align-items-center" style="width:100%;">
                        <div class="logo">
                            ...
                            <?php if(!empty($general_setting->logo_red)): ?>
                                <a class="logo-promo" href="<?php echo e(route('home')); ?>" style="display:none;"><img
...
<!-- header-area-end --><?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme3/views/components/header.blade.php ENDPATH**/ ?>