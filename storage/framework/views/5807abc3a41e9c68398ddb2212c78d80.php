<?php
    $theme4_counter = getContent('theme4_counter.content', true);
    $translatedSlides = getTranslatedSlides($theme4_counter, 'slides');
?>

<?php if(count($translatedSlides) > 0): ?>
    <!-- tg-counter-area-start -->
    <div class="tg-counter-area tg-counter-su-2 pt-85 pb-55">
        <div class="container">
            <div class="row">
...
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme4/views/components/counter.blade.php ENDPATH**/ ?>