...
<div class="admin-menu__one crancy-sidebar-padding mg-top-20">
    ...
    <div class="menu-bar">
        <ul id="CrancyMenu" class="menu-bar__one crancy-dashboard-menu">
            ...
            <li class="<?php echo e(Route::is('admin.quote-requests.*') ? 'active' : ''); ?>">
                <a class="collapsed" href="<?php echo e(route('admin.quote-requests.index')); ?>">
                    <span class="menu-bar__text">
                        ...
                        <span class="menu-bar__name"><?php echo e(__('translate.Quote Requests')); ?></span>
                    </span>
                </a>
            </li>
