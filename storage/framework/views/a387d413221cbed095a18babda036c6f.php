...
<title><?php echo e(__('translate.Create Promotion')); ?></title>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('body-header'); ?>
<h3 class="crancy-header__title m-0"><?php echo e(__('translate.Create Promotion')); ?></h3>
<p class="crancy-header__text"><?php echo e(__('translate.Manage Content')); ?> >> <?php echo e(__('translate.Promotions')); ?> >> <?php echo e(__('translate.Create')); ?></p>
<?php $__env->stopSection(); ?>
                ...
                <div class="crancy-body">
                    <div class="crancy-dsinner">
                        <div class="crancy-table crancy-table--v3 mg-top-30">
                            <form action="<?php echo e(route('admin.promotion.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="crancy-table__inner">
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <input type="text" name="title" class="crancy-form__control" value="<?php echo e(old('title')); ?>" placeholder="<?php echo e(__('translate.e.g. Summer Sale')); ?>" required>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <textarea name="message" class="crancy-form__control" rows="3" placeholder="<?php echo e(__('translate.Enter the promotional message that will scroll across the bar')); ?>" required><?php echo e(old('message')); ?></textarea>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <input type="url" name="link_url" class="crancy-form__control" value="<?php echo e(old('link_url')); ?>" placeholder="<?php echo e(__('translate.e.g. https://example.com/promotion')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <input type="text" name="link_text" class="crancy-form__control" value="<?php echo e(old('link_text')); ?>" placeholder="<?php echo e(__('translate.e.g. Shop Now')); ?>">
                                        ...
                                        <div class="crancy-table__inner">
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input d-flex align-items-center gap-2">
                                                    <input type="color" name="background_color" class="form-control form-control-color" value="<?php echo e(old('background_color', '#dc3545')); ?>" style="width: 50px; height: 40px;">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input d-flex align-items-center gap-2">
                                                    <input type="color" name="text_color" class="form-control form-control-color" value="<?php echo e(old('text_color', '#ffffff')); ?>" style="width: 50px; height: 40px;">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <input type="number" name="sort_order" class="crancy-form__control" value="<?php echo e(old('sort_order', 0)); ?>" placeholder="0">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <input type="date" name="starts_at" class="crancy-form__control" value="<?php echo e(old('starts_at')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                ...
                                                <div class="crancy-form__input">
                                                    <input type="date" name="ends_at" class="crancy-form__control" value="<?php echo e(old('ends_at')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="crancy-form__box mt-4">
                                                <button type="submit" class="crancy-btn crancy-btn__success w-100">
                                                    <i class="fas fa-save"></i> <?php echo e(__('translate.Save Promotion')); ?>
...
<?php echo $__env->make('admin.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\archive\archive\resources\views/admin/promotion/create.blade.php ENDPATH**/ ?>