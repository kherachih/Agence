        ...
        <div class="crancy-smenu" id="CrancyMenu">
            ...
            <div class="admin-menu">
                ...
                <div class="logo crancy-sidebar-padding pd-right-0">
                    <a class="crancy-logo" href="<?php echo e(route('admin.dashboard')); ?>">
                                                ...
                                                <div class="crancy-header__options">
                                                    ...
                                                    <div class="crancy-header__single crancy-header__single--messages">
                                                        <a class="crancy-header__blink"
                                                            href="<?php echo e(route('admin.contact-message')); ?>">
                                                    ...
                                                    <div class="crancy-header__settings">
                                                        <a class="crancy-header__blink"
                                                            href="<?php echo e(route('admin.general-setting')); ?>">
                                                ...
                                                <div class="crancy-header__single">
                                                    <a href="<?php echo e(route('admin.edit-profile')); ?>">
                                                        <div class="crancy-header__author-img">
                                                            <?php if($auth_admin?->image): ?>
                                                                <img src="<?php echo e(asset($auth_admin?->image)); ?>"
                                                                    alt="#">
                                                            <?php else: ?>
                                                                <img src="<?php echo e(asset($general_setting->default_avatar)); ?>"
                                                                    alt="#">
                                                            <?php endif; ?>
    ...
    <script>
        (function($) {
            ...
            $(document).ready(function() {
                ...
                const session_success = `<?php echo e(Session::get('success')); ?>`;
                const session_error = `<?php echo e(Session::get('error')); ?>`;
                if (session_success) {
...
<?php /**PATH D:\xampp\htdocs\archive\archive\resources\views/admin/master_layout.blade.php ENDPATH**/ ?>