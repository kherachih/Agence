...
<div class="tg-listing-area pt-110 pb-115 p-relative z-index-9">
    <img class="tg-listing-3-shape tg-listing-4-shape d-none d-xl-block"
        src="<?php echo e(asset('frontend/assets/img/shape/tree.png')); ?>" alt="">
    <div class="container">
        <div class="row align-items-end">
            <div class="col-lg-9">
                <div class="tg-location-section-title mb-40">
                    <h5 class="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                        <?php echo e(getTranslatedValue($theme6_tour_package, 'sub_title')); ?>

                    </h5>
                    <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">
                        <?php echo strip_tags(clean(getTranslatedValue($theme6_tour_package, 'title')), '<br>'); ?>
            ...
            <div class="col-lg-3">
                <div class="tg-location-3-btn text-end wow fadeInUp mb-40" data-wow-delay=".6s" data-wow-duration=".9s">
                    <a href="<?php echo e(getTranslatedValue($theme6_tour_package, 'button_url')); ?>"
                        class="tg-btn tg-btn-gray tg-btn-switch-animation">
                        <span class="d-flex align-items-center justify-content-center">
                            <span class="btn-text"><?php echo e(getTranslatedValue($theme6_tour_package, 'button_text')); ?></span>
        ...
        <?php if($theme6_popular_services && $theme6_popular_services->count() > 0): ?>
            <div class="row">
                <div class="col-12">
                    <div class="swiper-container tg-listing-slider p-relative fix">
                        <div class="swiper-wrapper mb-35">
                            <?php $__currentLoopData = $theme6_popular_services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(getTranslatedValue($theme6_tour_package, 'show_pagination') == '1'): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme6/views/components/tour-package.blade.php ENDPATH**/ ?>