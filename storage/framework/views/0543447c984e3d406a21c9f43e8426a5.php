...
<div class="tg-testimonial-area tg-grey-bg pt-100 pb-115 p-relative z-index-1">
    <img class="tg-testimonial-3-shape p-absolute d-none d-xl-block" src="<?php echo e(asset('frontend/assets/img/shape/pillar.png')); ?>" alt="">
    <img class="tg-testimonial-2-shape-1 p-absolute d-none d-lg-block" src="<?php echo e(asset('frontend/assets/img/shape/parasut.png')); ?>"
        alt="">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="tg-location-section-title text-center mb-30">
                    <h5 class="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                        <?php echo e(getTranslatedValue($theme5_testimonial, 'sub_title')); ?>

                    </h5>
                    <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">
                        <?php echo strip_tags(clean(getTranslatedValue($theme5_testimonial, 'title')), '<br>'); ?>

                    </h2>
                    <p class="text-capitalize wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".9s">
                        <?php echo strip_tags(clean(getTranslatedValue($theme5_testimonial, 'description')), '<br>'); ?>
            ...
            <?php if($testimonials->count() > 0): ?>
                <div class="swiper-container tg-testimonial-slider p-relative fix">
                            ...
                            <div class="swiper-slide">
                                <div class="tg-testimonial-item mb-30">
                                    <div
                                        ...
                                        <div class="tg-testimonial-avatar-inner d-flex align-items-center mr-20 mb-20">
                                            <div class="tg-testimonial-avatar-thumb mr-15">
                                                <img class="rounded-circale" src="<?php echo e($testimonial?->image); ?>"
                                                    alt="<?php echo e($testimonial?->translate?->name); ?>">
                                            </div>
                                            <div class="tg-testimonial-avatar-content">
                                                <h5><?php echo e($testimonial?->translate?->name); ?></h5>
                                                <span><?php echo e($testimonial?->translate?->designation); ?></span>
                                            </div>
                                        </div>
                                    ...
                                    <p class="tg-testimonial-avatar-para mb-10">“
                                        <?php echo e($testimonial?->translate?->comment); ?> ”</p>
                    ...
                    <?php if(getTranslatedValue($theme5_testimonial, 'show_pagination') == '1'): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme5/views/components/testimonial.blade.php ENDPATH**/ ?>