<?php $__env->startSection('title'); ?>
    <title><?php echo e(__('translate.Partner Login')); ?></title>
                ...
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="tg-login-wrapper">
                        <div class="tg-login-top text-center mb-30">
                            <h2><?php echo e(__('translate.Partner Login')); ?></h2>
                            <p><?php echo e(__('translate.Enter your credentials to access your partner account')); ?>.</p>
                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="tg-login-navigate mb-25">
                                                    <a
                                                        href="<?php echo e(route('agency.registration')); ?>"><?php echo e(__('translate.Register Now')); ?></a>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layout_inner_page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\archive\archive\resources\views/auth/partner_login.blade.php ENDPATH**/ ?>