...
<div class="tg-blog-area pt-130 pb-110 include-bg p-relative z-index-1"
    data-background="<?php echo e(asset('frontend/assets/img/shape/blog-shape-bg.jpg')); ?>">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="tg-location-section-title text-center mb-30">
                    <h5 class="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".9s">
                        <?php echo e(getTranslatedValue($theme6_blog, 'sub_title')); ?>

                    </h5>
                    <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                        <?php echo strip_tags(clean(getTranslatedValue($theme6_blog, 'title')), '<br>'); ?>

                    </h2>
                    <p class="text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">
                        <?php echo strip_tags(clean(getTranslatedValue($theme6_blog, 'description')), '<br>'); ?>
            ...
            <?php if($blogs->count() > 0): ?>
                <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow <?php echo e($animation); ?>" data-wow-delay=".4s"
                ...
                <div class="col-12 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                    <div class="tg-blog-bottom text-center pt-15">
                        <p> <?php echo e(__('translate.Want to see our Recent News & Updates.')); ?> <a
                                href="<?php echo e(route('blogs')); ?>"><?php echo e(__('translate.Click here to View More')); ?></a>
                        </p>
                    </div>
                </div>
            <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme6/views/components/blog.blade.php ENDPATH**/ ?>