<?php
    $theme6_why_choose = getContent('theme6_why_choose.content', true);
    $translatedSlides = getTranslatedSlides($theme6_why_choose, 'slides');
?>

<?php if($theme6_why_choose): ?>
    <!-- tg-chose-us-area-start -->
    <div class="tg-chose-area p-relative z-index-1  tg-grey-bg pt-140 pb-100">
        <img class="tg-chose-4-shape p-absolute" src="<?php echo e(asset('frontend/assets/img/shape/map-shape-5.png')); ?>"
            alt="shape">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="tg-chose-content mb-35">
                        <div class="tg-chose-section-title mb-30">
                            <h5 class="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".3s"
                                ...
                                <?php echo e(getTranslatedValue($theme6_why_choose, 'sub_title')); ?>

                            </h5>
                            <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                                <?php echo strip_tags(clean(getTranslatedValue($theme6_why_choose, 'title')), '<br>'); ?>

                            </h2>
                            <p class="text-capitalize wow fadeInUp mb-10" data-wow-delay=".5s" data-wow-duration=".9s">
                                <?php echo strip_tags(clean(getTranslatedValue($theme6_why_choose, 'description')), '<br>'); ?>
                        ...
                        <div class="tg-chose-list-wrap">
                            <?php $__currentLoopData = $translatedSlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="tg-chose-list d-flex mb-10 wow fadeInUp"
                                    data-wow-delay=".<?php echo e($key + 6); ?>s" data-wow-duration=".9s">
                            ...
                            <div class="tg-chose-btn wow fadeInUp" data-wow-delay=".8s" data-wow-duration=".9s">
                                <a href="<?php echo e(getTranslatedValue($theme6_why_choose, 'button_url')); ?>"
                                    class="tg-btn tg-btn-switch-animation">
                                    <span class="d-flex align-items-center justify-content-center">
                                        <span
                                            class="btn-text"><?php echo e(getTranslatedValue($theme6_why_choose, 'button_text')); ?></span>
                ...
                <div class="col-lg-7">
                    <div class="tg-chose-3-left tg-chose-4-right mb-35 pt-15">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="tg-chose-3-thumb">
                                    <div class="tg-chose-3-rounded p-relative mb-20">
                                        <img class="rotate-infinite-2"
                                            src="<?php echo e(asset('frontend/assets/img/shape/circle-text.png')); ?>"
                                            alt="">
                                        <img class="tg-chose-3-star"
                                            src="<?php echo e(asset('frontend/assets/img/shape/star.png')); ?>" alt="">
                                    </div>
                                    <img class="main-thumb"
                                        src="<?php echo e(asset(getSingleImage($theme6_why_choose, 'small_image'))); ?>"
                                        alt="thumb">
                                </div>
                            </div>
                                ...
                                <div class="tg-chose-3-thumb-inner p-relative">
                                    <div class="tg-chose-3-thumb-2">
                                        <img class="w-100 tg-round-15"
                                            src="<?php echo e(asset(getSingleImage($theme6_why_choose, 'big_image'))); ?>"
                                            alt="chose">
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme6/views/components/why-choose.blade.php ENDPATH**/ ?>