                                    ...
                                    <table class="crancy-table__main crancy-table__main-v3 dataTable no-footer" id="dataTable">
                                        ...
                                        <thead class="crancy-table__head">
                                            <tr>
                                                ...
                                                <th class="crancy-table__column-2 crancy-table__h2 sorting" >
                                                    <?php echo e(__('translate.Author')); ?>
                                        ...
                                        <tbody class="crancy-table__body">
                                            <?php $__currentLoopData = $support_tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $support_ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title"><?php echo e(html_decode($support_ticket?->author?->name)); ?></h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="<?php echo e(route('admin.support-ticket', $support_ticket->ticket_id)); ?>" class="crancy-btn"><i class="far fa-message"></i><?php echo e(__('translate.Chat')); ?></a>

                                                        <a onclick="itemDeleteConfrimation(<?php echo e($support_ticket->id); ?>)" href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModal" class="crancy-btn delete_danger_btn"><i class="fas fa-trash"></i> </a>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('admin.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\archive\archive\Modules/SupportTicket\resources/views/support/admin/index.blade.php ENDPATH**/ ?>