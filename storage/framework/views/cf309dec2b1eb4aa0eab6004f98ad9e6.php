        ...
        <div class="row gx-0">
            <div class="col-lg-4">
                <div class="tg-banner-content tg-banner-3-content banner-3 p-relative z-index-1 text-center">
                    ...
                    <h4 class="tg-banner-subtitle mb-10">
                        <?php echo e(getTranslatedValue($theme6_banner, 'sub_title')); ?>

                    </h4>
                    <h2 class="tg-banner-title mb-25">
                        <?php echo strip_tags(clean(getTranslatedValue($theme6_banner, 'title')), '<br>'); ?>

                    </h2>
                    <div class="tg-banner-btn">
                        <a href="<?php echo e(getTranslatedValue($theme6_banner, 'button_url')); ?>"
                            class="tg-btn tg-btn-switch-animation">
                            <span class="d-flex align-items-center justify-content-center">
                                <span class="btn-text"><?php echo e(getTranslatedValue($theme6_banner, 'button_text')); ?></span>
            ...
            <div class="col-lg-8">
                <div class="tg-banner-3-big-content banner-3 text-center include-bg"
                    data-background="<?php echo e(asset(getSingleImage($theme6_banner, 'background_image'))); ?>">
                    <h2><?php echo e(getTranslatedValue($theme6_banner, 'right_side_title_1')); ?></h2>
                    ...
                    <h2><?php echo e(getTranslatedValue($theme6_banner, 'right_side_title_2')); ?></h2>
                </div>
            </div>
        </div>
    </div>
...
<!-- tg-banner-area-end -->
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme6/views/components/banner.blade.php ENDPATH**/ ?>