                ...
                <div class="crancy-body">
                    <div class="crancy-dsinner">
                        <div class="crancy-table crancy-table--v3 mg-top-30">
                            <form action="<?php echo e(route('admin.promotion.update', $promotion->id)); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="crancy-table__inner">
                                            ...
                                            <div class="crancy-form__box mb-3">
                                                <label class="crancy-form__label"><?php echo e(__('translate.Custom Logo (Active when promotion is on)')); ?></label>
                                                <div class="crancy-form__input">
                                                    <?php if($promotion->logo): ?>
                                                        <div class="mb-2">
                                                            <img src="<?php echo e(asset($promotion->logo)); ?>" alt="Logo" style="max-height: 50px;">
                                                        </div>
                                                    <?php endif; ?>
                                                    <input type="file" name="logo" class="crancy-form__control">
                                                </div>
