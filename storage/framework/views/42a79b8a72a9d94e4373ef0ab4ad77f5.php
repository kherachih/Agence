                                                ...
                                                <div class="col-lg-4 col-md-6 col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="country"
                                                            value="<?php echo e(old('country', $service->country)); ?>"
                                                ...
                                                <div class="col-lg-4 col-md-6 col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="region"
                                                            value="<?php echo e(old('region', $service->region)); ?>"
                                                        ...
                                                        <div class="country-info-item mb-4 pb-4 border-bottom" data-index="<?php echo e($index); ?>">
                                                            <div class="row">
                                                                <div class="col-lg-6 col-12">
                                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                                        <label class="crancy__item-label"><?php echo e(__('translate.Country Name')); ?></label>
                                                                        <input class="crancy__item-input" type="text" name="good_to_know[<?php echo e($index); ?>][country]" value="<?php echo e($item['country'] ?? ''); ?>" placeholder="e.g. France">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6 col-12">
                                                                    <div class="crancy__item-form--group mg-top-form-20">
