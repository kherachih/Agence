<?php
    ...
    $home2_testimonial = getContent('theme2_testimonial.content', true);
    $testimonials = Testimonial::with('translate')->where('status', 'active')->latest()->get();
?>

<!-- tg-testimonial-area-start -->
<div class="tg-testimonial-area tg-grey-bg pt-130 pb-110 p-relative z-index-1">
    <img class="tg-testimonial-2-shape p-absolute" src="<?php echo e(asset('frontend/assets/img/shape/tower.png')); ?>" alt="">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="tg-location-section-title text-center mb-30">
                    <h5 class="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                        <?php echo e(getTranslatedValue($home2_testimonial, 'sub_title')); ?>

                    </h5>
                    <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">
                        <?php echo e(getTranslatedValue($home2_testimonial, 'title')); ?>

                    </h2>
                    <p class="text-capitalize wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".9s">
                        <?php echo strip_tags(clean(getTranslatedValue($home2_testimonial, 'description')), '<br>'); ?>
            ...
            <?php if($testimonials->count() > 0): ?>
                <div class="swiper-container tg-testimonial-slider p-relative fix">
                                    ...
                                    <div
                                        ...
                                        <div class="tg-testimonial-avatar-inner d-flex align-items-center mr-20 mb-20">
                                            <div class="tg-testimonial-avatar-thumb mr-15">
                                                <img class="rounded-circale" src="<?php echo e(asset($testimonial?->image)); ?>"
                    ...
                    <?php if(getTranslatedValue($home2_testimonial, 'show_pagination') == '1'): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\archive\archive\Cms/themes/theme2/views/components/testimonial.blade.php ENDPATH**/ ?>